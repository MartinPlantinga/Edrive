 ...
 */
#ifndef RTW_HEADER_PerformanceR1_h_
#define RTW_HEADER_PerformanceR1_h_
#ifndef PerformanceR1_COMMON_INCLUDES_
# define PerformanceR1_COMMON_INCLUDES_
#include <stdio.h>
#include <stddef.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* PerformanceR1_COMMON_INCLUDES_ */

#include "PerformanceR1_types.h"
...
#define PerformanceR1_rtModel          RT_MODEL_PerformanceR1
...
typedef struct {
  ...
  real_T Sum2;                         /* '<S1>/Sum2' */
  real_T Gain;                         /* '<S3>/Gain' */
  real_T DiscreteTransferFcn;          /* '<S3>/Discrete Transfer Fcn' */
  real_T DiscreteTransferFcn1;         /* '<S3>/Discrete Transfer Fcn1' */
  real_T LeadlagfilterT;               /* '<S3>/Leadlag filter T' */
  real_T Speed;                        /* '<S6>/Speed' */
  real_T Sum4;                         /* '<S1>/Sum4' */
  real_T Sum5;                         /* '<S1>/Sum5' */
  real_T Sum6;                         /* '<S1>/Sum6' */
  real_T ReferenceSolenoid;            /* '<S1>/Reference Solenoid' */
  real_T SFunction_d[4];               /* '<S7>/S-Function' */
  boolean_T RobotArm_sfcn_o3[3];       /* '<S2>/Robot Arm_sfcn' */
} BlockIO_PerformanceR1;
...
typedef struct {
  ...
  real_T DiscreteTransferFcn_DSTATE;   /* '<S3>/Discrete Transfer Fcn' */
  real_T DiscreteTransferFcn1_DSTATE[2];/* '<S3>/Discrete Transfer Fcn1' */
  real_T LeadlagfilterT_DSTATE;        /* '<S3>/Leadlag filter T' */
  ...
  real_T LeadlagfilterT_tmp;           /* '<S3>/Leadlag filter T' */
...
} D_Work_PerformanceR1;

/* Backward compatible GRT Identifiers */
#define rtB                            PerformanceR1_B
#define BlockIO                        BlockIO_PerformanceR1
#define rtXdot                         PerformanceR1_Xdot
#define StateDerivatives               StateDerivatives_PerformanceR1
#define tXdis                          PerformanceR1_Xdis
#define StateDisabled                  StateDisabled_PerformanceR1
#define rtP                            PerformanceR1_P
#define Parameters                     Parameters_PerformanceR1
#define rtDWork                        PerformanceR1_DWork
#define D_Work                         D_Work_PerformanceR1

/* Parameters (auto storage) */
struct Parameters_PerformanceR1_ {
  ...
  real_T DiscreteTransferFcn_InitialStat;/* Expression: 0
                                          ...
                                          */
  real_T DiscreteTransferFcn_Numerator[2];/* Expression: [1 -0.9923]
                                           * Referenced by: '<S3>/Discrete Transfer Fcn'
                                           */
  real_T DiscreteTransferFcn_Denominator[2];/* Expression: [1 -1]
                                             * Referenced by: '<S3>/Discrete Transfer Fcn'
                                             */
  real_T DiscreteTransferFcn1_InitialSta;/* Expression: 0
                                          * Referenced by: '<S3>/Discrete Transfer Fcn1'
                                          */
  real_T DiscreteTransferFcn1_Numerator[2];/* Expression: [0.14 0.1049]
                                            * Referenced by: '<S3>/Discrete Transfer Fcn1'
                                            */
  real_T DiscreteTransferFcn1_Denominato[3];/* Expression: [1  -1.179 0.4236]
                                             * Referenced by: '<S3>/Discrete Transfer Fcn1'
                                             */
  real_T LeadlagfilterT_InitialStates; /* Expression: 0
                                        * Referenced by: '<S3>/Leadlag filter T'
                                        */
  real_T LeadlagfilterT_Numerator[2];  /* Expression: [13.33 -13.07]
                                        * Referenced by: '<S3>/Leadlag filter T'
                                        */
  real_T LeadlagfilterT_Denominator[2];/* Expression: [1 -0.7358]
                                        * Referenced by: '<S3>/Leadlag filter T'
                                        */
  ...
  real_T Gain_Gain_c;                  /* Expression: 1
                                        ...
                                        */
  real_T Gain_Gain_f;                  /* Expression: 0.003
  ...
  real_T fcpos_Value;                  /* Expression: 0.2
                                        ...
                                        */
  real_T fcneg1_Value;                 /* Expression: -0.17
  ...
  real_T FeedforwardX_Value;           /* Expression: 0
                                        ...
                                        */
  real_T FeedforwardZ_Value;           /* Expression: 0
  ...
  real_T SFunction_P1_Size_m[2];       /* Computed Parameter: SFunction_P1_Size_m
                                        ...
                                        */
  real_T SFunction_P1_b;               /* Expression: 4096
                                        * Referenced by: '<S7>/S-Function'
                                        */
...
extern Parameters_PerformanceR1 PerformanceR1_P;

/* Block signals (auto storage) */
extern BlockIO_PerformanceR1 PerformanceR1_B;

/* Block states (auto storage) */
extern D_Work_PerformanceR1 PerformanceR1_DWork;

/* External data declarations for dependent source files */
extern const real_T PerformanceR1_RGND;/* real_T ground */
extern const real_T PerformanceR1_RGND;/* real_T ground */

/* Model entry point functions */
extern void PerformanceR1_initialize(boolean_T firstTime);
extern void PerformanceR1_output(int_T tid);
extern void PerformanceR1_update(int_T tid);
extern void PerformanceR1_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_PerformanceR1 *const PerformanceR1_M;
 ...
 *
 * '<Root>' : 'PerformanceR1'
 * '<S1>'   : 'PerformanceR1/Controller'
 * '<S2>'   : 'PerformanceR1/Robot Arm'
 * '<S3>'   : 'PerformanceR1/Controller/Controller R'
 * '<S4>'   : 'PerformanceR1/Controller/Controller X'
 * '<S5>'   : 'PerformanceR1/Controller/Controller Z'
 * '<S6>'   : 'PerformanceR1/Controller/Feedforward R'
 * '<S7>'   : 'PerformanceR1/Controller/RTScope'
 * '<S8>'   : 'PerformanceR1/Controller/Subsystem'
 * '<S9>'   : 'PerformanceR1/Robot Arm/__InputSSForSFun__'
 * '<S10>'  : 'PerformanceR1/Robot Arm/__OutputSSForSFun__'
 */
#endif                                 /* RTW_HEADER_PerformanceR1_h_ */
