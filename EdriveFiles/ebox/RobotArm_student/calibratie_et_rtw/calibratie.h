 ...
 */
#ifndef RTW_HEADER_calibratie_h_
#define RTW_HEADER_calibratie_h_
#ifndef calibratie_COMMON_INCLUDES_
# define calibratie_COMMON_INCLUDES_
#include <stddef.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* calibratie_COMMON_INCLUDES_ */

#include "calibratie_types.h"
...
#define calibratie_rtModel             RT_MODEL_calibratie
...
typedef struct {
  ...
  real_T GainR_o;                      /* '<S4>/GainR' */
  real_T DctintegratorR_b;             /* '<S4>/DctintegratorR' */
  real_T DctleadlagR_k;                /* '<S4>/DctleadlagR' */
  real_T Dct2lowpassR_g;               /* '<S4>/Dct2lowpassR' */
  real_T GainR_p;                      /* '<S5>/GainR' */
  real_T DctintegratorR_l;             /* '<S5>/DctintegratorR' */
  real_T DctleadlagR_d;                /* '<S5>/DctleadlagR' */
  real_T Dct2lowpassR_d;               /* '<S5>/Dct2lowpassR' */
  real_T Speed;                        /* '<S6>/Speed' */
  real_T Speed_e;                      /* '<S7>/Speed' */
  real_T Speed_a;                      /* '<S8>/Speed' */
  real_T Sum4;                         /* '<S1>/Sum4' */
  real_T Sum5;                         /* '<S1>/Sum5' */
  real_T Sum6;                         /* '<S1>/Sum6' */
...
typedef struct {
  ...
  real_T DctintegratorR_RWORK_o[2];    /* '<S4>/DctintegratorR' */
  real_T DctleadlagR_RWORK_k[2];       /* '<S4>/DctleadlagR' */
  real_T Dct2lowpassR_RWORK_b[4];      /* '<S4>/Dct2lowpassR' */
  real_T DctintegratorR_RWORK_j[2];    /* '<S5>/DctintegratorR' */
  real_T DctleadlagR_RWORK_kb[2];      /* '<S5>/DctleadlagR' */
  ...
  struct {
    ...
    real_T TimeStampB;
    real_T LastUAtTimeB;
  } Acceleration_RWORK_h;              /* '<S7>/Acceleration' */
  ...
  struct {
    ...
    real_T TimeStampB;
    real_T LastUAtTimeB;
  } Acceleration_RWORK_a;              /* '<S8>/Acceleration' */
...
#define rtB                            calibratie_B
#define BlockIO                        BlockIO_calibratie
#define rtXdot                         calibratie_Xdot
#define StateDerivatives               StateDerivatives_calibratie
#define tXdis                          calibratie_Xdis
#define StateDisabled                  StateDisabled_calibratie
#define rtP                            calibratie_P
#define Parameters                     Parameters_calibratie
#define rtDWork                        calibratie_DWork
#define D_Work                         D_Work_calibratie

/* Parameters (auto storage) */
struct Parameters_calibratie_ {
  ...
  real_T Solenoid_Y0;                  /* Expression: 0
                                        ...
                                        */
  real_T Constant_Value;               /* Expression: 0.1642
  ...
  real_T Dct2lowpassR_P3;              /* Expression: 0.001
                                        * Referenced by: '<S3>/Dct2lowpassR'
                                        */
  real_T GainR_Gain_m;                 /* Expression: 50
                                        * Referenced by: '<S4>/GainR'
                                        */
  real_T DctintegratorR_P1_Size_p[2];  /* Computed Parameter: DctintegratorR_P1_Size_p
                                        * Referenced by: '<S4>/DctintegratorR'
                                        */
  real_T DctintegratorR_P1_j;          /* Expression: f_num
                                        * Referenced by: '<S4>/DctintegratorR'
                                        */
  ...
  real_T DctleadlagR_P1_Size_h[2];     /* Computed Parameter: DctleadlagR_P1_Size_h
                                        ...
                                        */
  real_T DctleadlagR_P1_k;             /* Expression: f_num
                                        * Referenced by: '<S4>/DctleadlagR'
                                        */
  real_T DctleadlagR_P2_Size_h[2];     /* Computed Parameter: DctleadlagR_P2_Size_h
                                        * Referenced by: '<S4>/DctleadlagR'
                                        */
  real_T DctleadlagR_P2_d;             /* Expression: f_den
                                        * Referenced by: '<S4>/DctleadlagR'
                                        */
  real_T DctleadlagR_P3_Size_e[2];     /* Computed Parameter: DctleadlagR_P3_Size_e
                                        * Referenced by: '<S4>/DctleadlagR'
                                        */
  real_T DctleadlagR_P3_e;             /* Expression: 0.001
                                        * Referenced by: '<S4>/DctleadlagR'
                                        */
  real_T Dct2lowpassR_P1_Size_c[2];    /* Computed Parameter: Dct2lowpassR_P1_Size_c
  ...
  real_T Dct2lowpassR_P2_k;            /* Expression: b_den
                                        * Referenced by: '<S4>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P3_Size_j[2];    /* Computed Parameter: Dct2lowpassR_P3_Size_j
                                        * Referenced by: '<S4>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P3_n;            /* Expression: 0.001
                                        * Referenced by: '<S4>/Dct2lowpassR'
                                        */
  real_T GainR_Gain_j;                 /* Expression: 70
  ...
  real_T DctintegratorR_P1_d;          /* Expression: f_num
                                        * Referenced by: '<S5>/DctintegratorR'
                                        */
  real_T DctintegratorR_P2_Size_o[2];  /* Computed Parameter: DctintegratorR_P2_Size_o
                                        * Referenced by: '<S5>/DctintegratorR'
                                        */
  real_T DctintegratorR_P2_h3;         /* Expression: 0.001
                                        * Referenced by: '<S5>/DctintegratorR'
                                        */
  real_T DctleadlagR_P1_Size_e[2];     /* Computed Parameter: DctleadlagR_P1_Size_e
                                        * Referenced by: '<S5>/DctleadlagR'
                                        */
  real_T DctleadlagR_P1_p;             /* Expression: f_num
                                        * Referenced by: '<S5>/DctleadlagR'
                                        */
  real_T DctleadlagR_P2_Size_f[2];     /* Computed Parameter: DctleadlagR_P2_Size_f
                                        * Referenced by: '<S5>/DctleadlagR'
                                        */
  real_T DctleadlagR_P2_m;             /* Expression: f_den
                                        * Referenced by: '<S5>/DctleadlagR'
                                        */
  real_T DctleadlagR_P3_Size_o[2];     /* Computed Parameter: DctleadlagR_P3_Size_o
                                        * Referenced by: '<S5>/DctleadlagR'
                                        */
  ...
  real_T Dct2lowpassR_P1_o;            /* Expression: f_den
                                        * Referenced by: '<S5>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P2_Size_ij[2];   /* Computed Parameter: Dct2lowpassR_P2_Size_ij
                                        * Referenced by: '<S5>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P2_o;            /* Expression: b_den
                                        * Referenced by: '<S5>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P3_Size_p[2];    /* Computed Parameter: Dct2lowpassR_P3_Size_p
                                        * Referenced by: '<S5>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P3_o;            /* Expression: 0.001
                                        * Referenced by: '<S5>/Dct2lowpassR'
                                        */
  ...
  real_T speed0_Value;                 /* Expression: 0
                                        ...
                                        */
  real_T Gain_Gain_l;                  /* Expression: 0.0015
                                        * Referenced by: '<S7>/Gain'
                                        */
  real_T Gain1_Gain_l;                 /* Expression: 0.001
                                        * Referenced by: '<S7>/Gain1'
                                        */
  real_T fcpos_Value_k;                /* Expression: 0.15
                                        * Referenced by: '<S7>/fc pos'
                                        */
  real_T fcneg_Value_e;                /* Expression: -0.3
                                        * Referenced by: '<S7>/fc neg'
                                        */
  real_T speed0_Value_b;               /* Expression: 0
                                        * Referenced by: '<S7>/speed0'
                                        */
  real_T Gain_Gain_j;                  /* Expression: 0.002
                                        * Referenced by: '<S8>/Gain'
                                        */
  real_T Gain1_Gain_j;                 /* Expression: 0.001
                                        * Referenced by: '<S8>/Gain1'
                                        */
  real_T fcpos_Value_e;                /* Expression: 0.2
                                        * Referenced by: '<S8>/fc pos'
                                        */
  real_T fcneg_Value_g;                /* Expression: -0.35
                                        * Referenced by: '<S8>/fc neg'
                                        */
  real_T speed0_Value_n;               /* Expression: 0
...
extern Parameters_calibratie calibratie_P;

/* Block signals (auto storage) */
extern BlockIO_calibratie calibratie_B;

/* Block states (auto storage) */
extern D_Work_calibratie calibratie_DWork;

/* External data declarations for dependent source files */
extern const real_T calibratie_RGND;   /* real_T ground */
extern const real_T calibratie_RGND;   /* real_T ground */

/* Model entry point functions */
extern void calibratie_initialize(boolean_T firstTime);
extern void calibratie_output(int_T tid);
extern void calibratie_update(int_T tid);
extern void calibratie_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_calibratie *const calibratie_M;
 ...
 *
 * '<Root>' : 'calibratie'
 * '<S1>'   : 'calibratie/Controller'
 * '<S2>'   : 'calibratie/Robot Arm'
 * '<S3>'   : 'calibratie/Controller/Controller R'
 * '<S4>'   : 'calibratie/Controller/Controller X'
 * '<S5>'   : 'calibratie/Controller/Controller Z'
 * '<S6>'   : 'calibratie/Controller/Feedforward R'
 * '<S7>'   : 'calibratie/Controller/Feedforward X'
 * '<S8>'   : 'calibratie/Controller/Feedforward Z'
 * '<S9>'   : 'calibratie/Controller/RTScope'
 * '<S10>'  : 'calibratie/Robot Arm/__InputSSForSFun__'
 * '<S11>'  : 'calibratie/Robot Arm/__OutputSSForSFun__'
 */
#endif                                 /* RTW_HEADER_calibratie_h_ */
