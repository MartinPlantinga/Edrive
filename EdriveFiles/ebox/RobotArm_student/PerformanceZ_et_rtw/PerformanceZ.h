 ...
 */
#ifndef RTW_HEADER_PerformanceZ_h_
#define RTW_HEADER_PerformanceZ_h_
#ifndef PerformanceZ_COMMON_INCLUDES_
# define PerformanceZ_COMMON_INCLUDES_
#include <stdio.h>
#include <stddef.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* PerformanceZ_COMMON_INCLUDES_ */

#include "PerformanceZ_types.h"
...
#define PerformanceZ_rtModel           RT_MODEL_PerformanceZ
...
typedef struct {
  ...
  real_T Sum;                          /* '<S6>/Sum' */
  real_T Gain;                         /* '<S5>/Gain' */
  real_T Dctintegrator;                /* '<S5>/Dctintegrator' */
  real_T Dctleadlag;                   /* '<S5>/Dctleadlag' */
  real_T Dct2lowpass;                  /* '<S5>/Dct2lowpass' */
  real_T Sum4;                         /* '<S1>/Sum4' */
  real_T Sum5;                         /* '<S1>/Sum5' */
  real_T Sum6;                         /* '<S1>/Sum6' */
  real_T ReferenceSolenoid;            /* '<S1>/Reference Solenoid' */
  real_T SFunction[4];                 /* '<S7>/S-Function' */
  real_T SFunction_g[3];               /* '<S8>/S-Function' */
  boolean_T RobotArm_sfcn_o3[3];       /* '<S2>/Robot Arm_sfcn' */
} BlockIO_PerformanceZ;
...
typedef struct {
  ...
  real_T Dctintegrator_RWORK[2];       /* '<S5>/Dctintegrator' */
  real_T Dctleadlag_RWORK[2];          /* '<S5>/Dctleadlag' */
  real_T Dct2lowpass_RWORK[4];         /* '<S5>/Dct2lowpass' */
...
#define rtB                            PerformanceZ_B
#define BlockIO                        BlockIO_PerformanceZ
#define rtXdot                         PerformanceZ_Xdot
#define StateDerivatives               StateDerivatives_PerformanceZ
#define tXdis                          PerformanceZ_Xdis
#define StateDisabled                  StateDisabled_PerformanceZ
#define rtP                            PerformanceZ_P
#define Parameters                     Parameters_PerformanceZ
#define rtDWork                        PerformanceZ_DWork
#define D_Work                         D_Work_PerformanceZ

/* Parameters (auto storage) */
struct Parameters_PerformanceZ_ {
  ...
  real_T Solenoid_Y0;                  /* Expression: 0
                                        ...
                                        */
  real_T ReferenceX1_Value;            /* Expression: 0
                                        * Referenced by: '<S1>/Reference X1'
                                        */
  real_T Gain_Gain;                    /* Expression: 0.002
                                        * Referenced by: '<S6>/Gain'
                                        */
  real_T fcpos_Value;                  /* Expression: 0.2
                                        * Referenced by: '<S6>/fc pos'
                                        */
  real_T fcneg_Value;                  /* Expression: -0.35
  ...
  real_T Gain1_Gain;                   /* Expression: 0.001
                                        ...
                                        */
  real_T gravitation_Value;            /* Expression: 0.25
                                        * Referenced by: '<S6>/gravitation'
                                        */
  real_T Gain_Gain_c;                  /* Expression: 40
  ...
  real_T SFunction_P1_Size_j[2];       /* Computed Parameter: SFunction_P1_Size_j
                                        ...
                                        */
  real_T SFunction_P1_i[6];            /* Expression: ref_part
                                        * Referenced by: '<S8>/S-Function'
                                        */
...
extern Parameters_PerformanceZ PerformanceZ_P;

/* Block signals (auto storage) */
extern BlockIO_PerformanceZ PerformanceZ_B;

/* Block states (auto storage) */
extern D_Work_PerformanceZ PerformanceZ_DWork;

/* External data declarations for dependent source files */
extern const real_T PerformanceZ_RGND; /* real_T ground */
extern const real_T PerformanceZ_RGND; /* real_T ground */

/* Model entry point functions */
extern void PerformanceZ_initialize(boolean_T firstTime);
extern void PerformanceZ_output(int_T tid);
extern void PerformanceZ_update(int_T tid);
extern void PerformanceZ_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_PerformanceZ *const PerformanceZ_M;
 ...
 *
 * '<Root>' : 'PerformanceZ'
 * '<S1>'   : 'PerformanceZ/Controller'
 * '<S2>'   : 'PerformanceZ/Robot Arm'
 * '<S3>'   : 'PerformanceZ/Controller/Controller R'
 * '<S4>'   : 'PerformanceZ/Controller/Controller X'
 * '<S5>'   : 'PerformanceZ/Controller/Controller Z'
 * '<S6>'   : 'PerformanceZ/Controller/Feedforward Z'
 * '<S7>'   : 'PerformanceZ/Controller/RTScope'
 * '<S8>'   : 'PerformanceZ/Controller/Subsystem'
 * '<S9>'   : 'PerformanceZ/Robot Arm/__InputSSForSFun__'
 * '<S10>'  : 'PerformanceZ/Robot Arm/__OutputSSForSFun__'
 */
#endif                                 /* RTW_HEADER_PerformanceZ_h_ */
