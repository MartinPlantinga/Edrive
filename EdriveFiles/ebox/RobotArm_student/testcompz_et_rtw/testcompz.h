 ...
 */
#ifndef RTW_HEADER_testcompz_h_
#define RTW_HEADER_testcompz_h_
#ifndef testcompz_COMMON_INCLUDES_
# define testcompz_COMMON_INCLUDES_
#include <stdio.h>
#include <stddef.h>
#include <math.h>
#include <string.h>
...
#endif                                 /* testcompz_COMMON_INCLUDES_ */

#include "testcompz_types.h"
...
#define testcompz_rtModel              RT_MODEL_testcompz
...
#define rtB                            testcompz_B
#define BlockIO                        BlockIO_testcompz
#define rtXdot                         testcompz_Xdot
#define StateDerivatives               StateDerivatives_testcompz
#define tXdis                          testcompz_Xdis
#define StateDisabled                  StateDisabled_testcompz
#define rtP                            testcompz_P
#define Parameters                     Parameters_testcompz
#define rtDWork                        testcompz_DWork
#define D_Work                         D_Work_testcompz

/* Parameters (auto storage) */
struct Parameters_testcompz_ {
  ...
  real_T Gain_Gain;                    /* Expression: 2
                                        ...
                                        */
  real_T ReferenceX_Value;             /* Expression: 0.2
  ...
  real_T FeedforwardR_Value;           /* Expression: 0
                                        ...
                                        */
  real_T FeedforwardX_Value;           /* Expression: 0.1
                                        * Referenced by: '<S1>/Feedforward X'
                                        */
  real_T Gravitycomp_Value;            /* Expression: 0.25
                                        * Referenced by: '<S1>/Gravity comp'
                                        */
  real_T frictionleft_Value;           /* Expression: 0
                                        * Referenced by: '<S1>/friction left'
                                        */
  real_T frictionright_Value;          /* Expression: 0
...
extern Parameters_testcompz testcompz_P;

/* Block signals (auto storage) */
extern BlockIO_testcompz testcompz_B;

/* Block states (auto storage) */
extern D_Work_testcompz testcompz_DWork;

/* External data declarations for dependent source files */
extern const real_T testcompz_RGND;    /* real_T ground */
extern const real_T testcompz_RGND;    /* real_T ground */

/* Model entry point functions */
extern void testcompz_initialize(boolean_T firstTime);
extern void testcompz_output(int_T tid);
extern void testcompz_update(int_T tid);
extern void testcompz_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_testcompz *const testcompz_M;
 ...
 *
 * '<Root>' : 'testcompz'
 * '<S1>'   : 'testcompz/Controller'
 * '<S2>'   : 'testcompz/Robot Arm'
 * '<S3>'   : 'testcompz/Controller/Controller R'
 * '<S4>'   : 'testcompz/Controller/Controller X'
 * '<S5>'   : 'testcompz/Controller/Controller Z'
 * '<S6>'   : 'testcompz/Controller/RTScope'
 * '<S7>'   : 'testcompz/Robot Arm/__InputSSForSFun__'
 * '<S8>'   : 'testcompz/Robot Arm/__OutputSSForSFun__'
 */
#endif                                 /* RTW_HEADER_testcompz_h_ */
