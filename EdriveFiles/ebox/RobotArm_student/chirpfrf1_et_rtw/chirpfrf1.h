 ...
 */
#ifndef RTW_HEADER_chirpfrf1_h_
#define RTW_HEADER_chirpfrf1_h_
#ifndef chirpfrf1_COMMON_INCLUDES_
# define chirpfrf1_COMMON_INCLUDES_
#include <stdio.h>
#include <stddef.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* chirpfrf1_COMMON_INCLUDES_ */

#include "chirpfrf1_types.h"
...
#define chirpfrf1_rtModel              RT_MODEL_chirpfrf1
...
#define rtB                            chirpfrf1_B
#define BlockIO                        BlockIO_chirpfrf1
#define rtXdot                         chirpfrf1_Xdot
#define StateDerivatives               StateDerivatives_chirpfrf1
#define tXdis                          chirpfrf1_Xdis
#define StateDisabled                  StateDisabled_chirpfrf1
#define rtP                            chirpfrf1_P
#define Parameters                     Parameters_chirpfrf1
#define rtDWork                        chirpfrf1_DWork
#define D_Work                         D_Work_chirpfrf1

/* Parameters (auto storage) */
struct Parameters_chirpfrf1_ {
...
extern Parameters_chirpfrf1 chirpfrf1_P;

/* Block signals (auto storage) */
extern BlockIO_chirpfrf1 chirpfrf1_B;

/* Block states (auto storage) */
extern D_Work_chirpfrf1 chirpfrf1_DWork;

/* External data declarations for dependent source files */
extern const real_T chirpfrf1_RGND;    /* real_T ground */
extern const real_T chirpfrf1_RGND;    /* real_T ground */

/* Model entry point functions */
extern void chirpfrf1_initialize(boolean_T firstTime);
extern void chirpfrf1_output(int_T tid);
extern void chirpfrf1_update(int_T tid);
extern void chirpfrf1_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_chirpfrf1 *const chirpfrf1_M;
 ...
 *
 * '<Root>' : 'chirpfrf1'
 * '<S1>'   : 'chirpfrf1/Controller'
 * '<S2>'   : 'chirpfrf1/Robot Arm'
 * '<S3>'   : 'chirpfrf1/Controller/Controller R'
 * '<S4>'   : 'chirpfrf1/Controller/Controller X'
 * '<S5>'   : 'chirpfrf1/Controller/Controller Z'
 * '<S6>'   : 'chirpfrf1/Controller/RTScope'
 * '<S7>'   : 'chirpfrf1/Robot Arm/__InputSSForSFun__'
 * '<S8>'   : 'chirpfrf1/Robot Arm/__OutputSSForSFun__'
 */
#endif                                 /* RTW_HEADER_chirpfrf1_h_ */
