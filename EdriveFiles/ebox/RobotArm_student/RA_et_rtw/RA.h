...
#define rtB                            RA_B
#define BlockIO                        BlockIO_RA
#define rtXdot                         RA_Xdot
#define StateDerivatives               StateDerivatives_RA
#define tXdis                          RA_Xdis
#define StateDisabled                  StateDisabled_RA
#define rtP                            RA_P
#define Parameters                     Parameters_RA
#define rtDWork                        RA_DWork
#define D_Work                         D_Work_RA

/* Parameters (auto storage) */
struct Parameters_RA_ {
  ...
  real_T Gain_Gain;                    /* Expression: 5
                                        ...
                                        */
  real_T ReferenceR_Value;             /* Expression: 0.25
                                        * Referenced by: '<S1>/Reference R'
                                        */
  real_T Gain_Gain_i;                  /* Expression: 20
                                        * Referenced by: '<S3>/Gain'
                                        */
  real_T ReferenceX_Value;             /* Expression: 0.5
...
extern Parameters_RA RA_P;

/* Block signals (auto storage) */
extern BlockIO_RA RA_B;

/* Block states (auto storage) */
extern D_Work_RA RA_DWork;
...
extern void RA_initialize(boolean_T firstTime);
extern void RA_output(int_T tid);
extern void RA_update(int_T tid);
extern void RA_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_RA *const RA_M;
 ...
 * '<S1>'   : 'RA/Controller'
 * '<S2>'   : 'RA/Robot Arm'
 * '<S3>'   : 'RA/Controller/Controller R'
 * '<S4>'   : 'RA/Controller/Controller X'
 * '<S5>'   : 'RA/Controller/Controller Z'
 * '<S6>'   : 'RA/Controller/RTScope'
 * '<S7>'   : 'RA/Robot Arm/__InputSSForSFun__'
 * '<S8>'   : 'RA/Robot Arm/__OutputSSForSFun__'
 */
