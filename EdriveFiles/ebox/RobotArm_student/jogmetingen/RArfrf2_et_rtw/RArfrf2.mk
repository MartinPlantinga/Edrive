...
#
# File    : RArfrf2.mk   $Revision: 1.81.4.22.2.1 $
#
# Abstract:
...
MODEL                = RArfrf2
MODULES              = RArfrf2_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_matrx.c rt_nonfinite.c rt_printf.c rt_sfcn_helper.c 
MAKEFILE             = RArfrf2.mk
MATLAB_ROOT          = /usr/local/matlab2011b
ALT_MATLAB_ROOT      = /usr/local/matlab2011b
S_FUNCTIONS          = ref3.c dleadlag.c dlowpass1.c sf_rt_scope.c Robot_sf.c dlowpass2.c dnotch.c dpd.c dweakint.c ec_Ebox.c ec_EboxResetEnc.c
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 2
TID01EQ              = 1
NCSTATES             = 0
COMPUTER             = GLNXA64
BUILDARGS            = OPTS="-DNETIF_ID=2" GENERATE_REPORT=0
MULTITASKING         = 0
EXT_MODE             = 1
...
ADD_INCLUDES = \
	-I/home/ebox/Documents/RobotArm_student/jogmetingen/RArfrf2_et_rtw \
	-I/home/ebox/Documents/RobotArm_student/jogmetingen \
	-I/home/ebox/Documents/RobotArm_student \
...
%.o : $(MATLAB_ROOT)/toolbox/ref3ma/%.c
	@$(GCC_TEST_CMD) $< $(GCC_TEST_OUT)
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $<
...
%.o : /home/ebox/Documents/RobotArm_student/%.c
	@$(GCC_TEST_CMD) $< $(GCC_TEST_OUT)
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $<
...
%.o : $(MATLAB_ROOT)/rtw/c/src/rtiostream/rtiostreamtcpip/%.cpp
	@$(GCC_TEST_CMD) $< $(GCC_TEST_OUT)
	$(CPP) -c $(CPPFLAGS) $<
%.o : $(MATLAB_ROOT)/toolbox/ref3ma/%.cpp
	@$(GCC_TEST_CMD) $< $(GCC_TEST_OUT)
	$(CPP) -c $(CPPFLAGS) $<
...
%.o : /home/ebox/svn/trunk/src/E-box/Apps/E-Scope/engine/%.cpp
	@$(GCC_TEST_CMD) $< $(GCC_TEST_OUT)
	$(CPP) -c $(CPPFLAGS) $<
%.o : /home/ebox/Documents/RobotArm_student/%.cpp
	@$(GCC_TEST_CMD) $< $(GCC_TEST_OUT)
	$(CPP) -c $(CPPFLAGS) $<
