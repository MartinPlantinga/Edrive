 ...
 */
#ifndef RTW_HEADER_chirpfrf2_h_
#define RTW_HEADER_chirpfrf2_h_
#ifndef chirpfrf2_COMMON_INCLUDES_
# define chirpfrf2_COMMON_INCLUDES_
#include <stdio.h>
#include <stddef.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* chirpfrf2_COMMON_INCLUDES_ */

#include "chirpfrf2_types.h"
...
#define chirpfrf2_rtModel              RT_MODEL_chirpfrf2
...
typedef struct {
  ...
  real_T Chirp_CURRENT_STEP;           /* '<S1>/Chirp' */
  real_T Chirp_ACC_PHASE;              /* '<S1>/Chirp' */
  real_T Chirp_BETA;                   /* '<S1>/Chirp' */
  real_T Chirp_MIN_FREQ;               /* '<S1>/Chirp' */
  real_T Chirp_PERIOD_THETA;           /* '<S1>/Chirp' */
  struct {
    void *FilePtr;
  ...
  boolean_T Chirp_SWEEP_DIRECTION;     /* '<S1>/Chirp' */
  boolean_T Controller_MODE;           /* '<Root>/Controller' */
} D_Work_chirpfrf2;

/* Backward compatible GRT Identifiers */
#define rtB                            chirpfrf2_B
#define BlockIO                        BlockIO_chirpfrf2
#define rtXdot                         chirpfrf2_Xdot
#define StateDerivatives               StateDerivatives_chirpfrf2
#define tXdis                          chirpfrf2_Xdis
#define StateDisabled                  StateDisabled_chirpfrf2
#define rtP                            chirpfrf2_P
#define Parameters                     Parameters_chirpfrf2
#define rtDWork                        chirpfrf2_DWork
#define D_Work                         D_Work_chirpfrf2

/* Parameters (auto storage) */
struct Parameters_chirpfrf2_ {
  real_T Solenoid_Y0;                  /* Expression: 0
                                        * Referenced by: '<S1>/Solenoid'
                                        */
  real_T Chirp_PERIOD_SWEEP;           /* Expression: Tsweep
                                        * Referenced by: '<S1>/Chirp'
                                        */
  real_T Chirp_PHASE;                  /* Expression: phase
                                        * Referenced by: '<S1>/Chirp'
                                        */
  real_T Chirp_TIME_TARGET;            /* Expression: t1
                                        * Referenced by: '<S1>/Chirp'
                                        */
  real_T Chirp_INITIAL_FREQ;           /* Expression: f0
                                        * Referenced by: '<S1>/Chirp'
                                        */
  real_T Chirp_FREQ_TARGET;            /* Expression: f1
                                        * Referenced by: '<S1>/Chirp'
                                        */
...
extern Parameters_chirpfrf2 chirpfrf2_P;

/* Block signals (auto storage) */
extern BlockIO_chirpfrf2 chirpfrf2_B;

/* Block states (auto storage) */
extern D_Work_chirpfrf2 chirpfrf2_DWork;

/* External data declarations for dependent source files */
extern const real_T chirpfrf2_RGND;    /* real_T ground */
extern const real_T chirpfrf2_RGND;    /* real_T ground */

/* Model entry point functions */
extern void chirpfrf2_initialize(boolean_T firstTime);
extern void chirpfrf2_output(int_T tid);
extern void chirpfrf2_update(int_T tid);
extern void chirpfrf2_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_chirpfrf2 *const chirpfrf2_M;
 ...
 *
 * '<Root>' : 'chirpfrf2'
 * '<S1>'   : 'chirpfrf2/Controller'
 * '<S2>'   : 'chirpfrf2/Robot Arm'
 * '<S3>'   : 'chirpfrf2/Controller/Controller R'
 * '<S4>'   : 'chirpfrf2/Controller/Controller X'
 * '<S5>'   : 'chirpfrf2/Controller/Controller Z'
 * '<S6>'   : 'chirpfrf2/Controller/RTScope'
 * '<S7>'   : 'chirpfrf2/Robot Arm/__InputSSForSFun__'
 * '<S8>'   : 'chirpfrf2/Robot Arm/__OutputSSForSFun__'
 */
#endif                                 /* RTW_HEADER_chirpfrf2_h_ */
