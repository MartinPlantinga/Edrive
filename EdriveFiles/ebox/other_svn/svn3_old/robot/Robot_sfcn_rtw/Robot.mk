...
MAKECMD         = /usr/local/matlab2011b/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
...
MODEL              = Robot
MODULES            = Robot_sf_data.c rtGetInf.c rtGetNaN.c 
MAKEFILE           = Robot.mk
MATLAB_ROOT        = /usr/local/matlab2011b
ALT_MATLAB_ROOT    = /usr/local/matlab2011b
MASTER_ANCHOR_DIR  = 
START_DIR          = /home/ebox/Documents/RobotArm_wide_original
S_FUNCTIONS        = ec_Ebox.c dweakint.c dpd.c dnotch.c dlowpass2.c ec_EboxResetEnc.c
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 2
TID01EQ            = 0
...
COMPUTER           = GLNXA64
MEXEXT             = mexa64
BUILDARGS          = OPTS="-DNETIF_ID=2" GENERATE_REPORT=0 MODELLIB=Robotlib.a RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE
USERMODULES        =  
CREATEMODEL        = 1
USEPARAMVALUES     = 0
PURIFY             = 0
