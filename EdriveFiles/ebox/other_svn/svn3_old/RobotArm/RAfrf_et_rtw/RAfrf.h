...
#ifndef RTW_HEADER_RAfrf_h_
#define RTW_HEADER_RAfrf_h_
#include <stddef.h>
#include <string.h>
#ifndef RAfrf_COMMON_INCLUDES_
# define RAfrf_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "dt_info.h"
#include "ext_work.h"
#endif                                 /* RAfrf_COMMON_INCLUDES_ */

#include "RAfrf_types.h"
...
#define RAfrf_rtModel                  RT_MODEL_RAfrf_T
...
#define rtB                            RAfrf_B
#define BlockIO                        B_RAfrf_T
#define rtP                            RAfrf_P
#define Parameters                     P_RAfrf_T
#define rtDWork                        RAfrf_DW
#define D_Work                         DW_RAfrf_T
...
extern P_RAfrf_T RAfrf_P;

/* Block signals (auto storage) */
extern B_RAfrf_T RAfrf_B;

/* Block states (auto storage) */
extern DW_RAfrf_T RAfrf_DW;

/* External data declarations for dependent source files */
extern const real_T RAfrf_RGND;        /* real_T ground */

/* Model entry point functions */
extern void RAfrf_initialize(void);
extern void RAfrf_output(void);
extern void RAfrf_update(void);
extern void RAfrf_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern RAfrf_rtModel *RAfrf(void);
...
extern RT_MODEL_RAfrf_T *const RAfrf_M;
 ...
 * '<S1>'   : 'RAfrf/Controller'
 * '<S2>'   : 'RAfrf/Robot Arm'
 * '<S3>'   : 'RAfrf/Controller/Controller R'
 * '<S4>'   : 'RAfrf/Controller/Controller X'
 * '<S5>'   : 'RAfrf/Controller/Controller Z'
 * '<S6>'   : 'RAfrf/Controller/RTScope'
 * '<S7>'   : 'RAfrf/Robot Arm/__InputSSForSFun__'
 * '<S8>'   : 'RAfrf/Robot Arm/__OutputSSForSFun__'
 */
#endif                                 /* RTW_HEADER_RAfrf_h_ */
