...
#ifndef RTW_HEADER_RAstudent_renamed_h_
#define RTW_HEADER_RAstudent_renamed_h_
#include <stddef.h>
#include <string.h>
#ifndef RAstudent_renamed_COMMON_INCLUDES_
# define RAstudent_renamed_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "dt_info.h"
#include "ext_work.h"
#endif                                 /* RAstudent_renamed_COMMON_INCLUDES_ */

#include "RAstudent_renamed_types.h"
...
#define RAstudent_renamed_rtModel      RT_MODEL_RAstudent_renamed_T
...
} DW_RAstudent_renamed_T;

/* Backward compatible GRT Identifiers */
#define rtB                            RAstudent_renamed_B
#define BlockIO                        B_RAstudent_renamed_T
#define rtP                            RAstudent_renamed_P
#define Parameters                     P_RAstudent_renamed_T
#define rtDWork                        RAstudent_renamed_DW
#define D_Work                         DW_RAstudent_renamed_T

/* Parameters (auto storage) */
struct P_RAstudent_renamed_T_ {
...
struct tag_RTM_RAstudent_renamed_T {
  const char_T *path;
...
extern P_RAstudent_renamed_T RAstudent_renamed_P;

/* Block signals (auto storage) */
extern B_RAstudent_renamed_T RAstudent_renamed_B;

/* Block states (auto storage) */
extern DW_RAstudent_renamed_T RAstudent_renamed_DW;

/* External data declarations for dependent source files */
extern const real_T RAstudent_renamed_RGND;/* real_T ground */

/* Model entry point functions */
extern void RAstudent_renamed_initialize(void);
extern void RAstudent_renamed_output(void);
extern void RAstudent_renamed_update(void);
extern void RAstudent_renamed_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern RAstudent_renamed_rtModel *RAstudent_renamed(void);
...
extern RT_MODEL_RAstudent_renamed_T *const RAstudent_renamed_M;
 ...
 *
 * '<Root>' : 'RAstudent_renamed'
 * '<S1>'   : 'RAstudent_renamed/Controller'
 * '<S2>'   : 'RAstudent_renamed/Robot Arm'
 * '<S3>'   : 'RAstudent_renamed/Controller/Controller R'
 * '<S4>'   : 'RAstudent_renamed/Controller/Controller X'
 * '<S5>'   : 'RAstudent_renamed/Controller/Controller Z'
 * '<S6>'   : 'RAstudent_renamed/Controller/RTScope'
 * '<S7>'   : 'RAstudent_renamed/Robot Arm/__InputSSForSFun__'
 * '<S8>'   : 'RAstudent_renamed/Robot Arm/__OutputSSForSFun__'
 */
#endif                                 /* RTW_HEADER_RAstudent_renamed_h_ */
