...
#ifndef RTW_HEADER_Performancetot_h_
#define RTW_HEADER_Performancetot_h_
#include <stddef.h>
#include <string.h>
#ifndef Performancetot_COMMON_INCLUDES_
# define Performancetot_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#include "dt_info.h"
#include "ext_work.h"
#endif                                 /* Performancetot_COMMON_INCLUDES_ */

#include "Performancetot_types.h"
...
#define Performancetot_rtModel         RT_MODEL_Performancetot_T
...
typedef struct {
  ...
  real_T FromFile;                     /* '<S1>/From File' */
  real_T Sum8;                         /* '<S1>/Sum8' */
  real_T Sum7;                         /* '<S1>/Sum7' */
  real_T GainR;                        /* '<S3>/GainR' */
  real_T DctintegratorR;               /* '<S3>/DctintegratorR' */
  real_T DctleadlagR;                  /* '<S3>/DctleadlagR' */
  real_T Dct2lowpassR;                 /* '<S3>/Dct2lowpassR' */
  real_T GainR_i;                      /* '<S4>/GainR' */
  real_T DctintegratorR_b;             /* '<S4>/DctintegratorR' */
  real_T DctleadlagR_g;                /* '<S4>/DctleadlagR' */
  real_T Dct2lowpassR_o;               /* '<S4>/Dct2lowpassR' */
  real_T GainR_m;                      /* '<S5>/GainR' */
  real_T DctintegratorR_e;             /* '<S5>/DctintegratorR' */
  real_T DctleadlagR_p;                /* '<S5>/DctleadlagR' */
  real_T Dct2lowpassR_a;               /* '<S5>/Dct2lowpassR' */
  real_T Speed;                        /* '<S6>/Speed' */
  real_T Speed_f;                      /* '<S7>/Speed' */
  real_T Speed_n;                      /* '<S8>/Speed' */
  real_T Sum4;                         /* '<S1>/Sum4' */
  real_T Sum5;                         /* '<S1>/Sum5' */
  real_T Sum6;                         /* '<S1>/Sum6' */
  real_T FromFile3;                    /* '<S1>/From File3' */
  real_T SFunction[4];                 /* '<S9>/S-Function' */
...
typedef struct {
  ...
  real_T TimeStampA;                   /* '<S6>/Speed' */
  real_T LastUAtTimeA;                 /* '<S6>/Speed' */
  real_T TimeStampB;                   /* '<S6>/Speed' */
  real_T LastUAtTimeB;                 /* '<S6>/Speed' */
  real_T TimeStampA_i;                 /* '<S6>/Acceleration' */
  real_T LastUAtTimeA_e;               /* '<S6>/Acceleration' */
  real_T TimeStampB_g;                 /* '<S6>/Acceleration' */
  real_T LastUAtTimeB_d;               /* '<S6>/Acceleration' */
  real_T TimeStampA_p;                 /* '<S7>/Speed' */
  real_T LastUAtTimeA_g;               /* '<S7>/Speed' */
  real_T TimeStampB_n;                 /* '<S7>/Speed' */
  real_T LastUAtTimeB_k;               /* '<S7>/Speed' */
  real_T TimeStampA_l;                 /* '<S7>/Acceleration' */
  real_T LastUAtTimeA_h;               /* '<S7>/Acceleration' */
  real_T TimeStampB_i;                 /* '<S7>/Acceleration' */
  real_T LastUAtTimeB_c;               /* '<S7>/Acceleration' */
  real_T TimeStampA_m;                 /* '<S8>/Speed' */
  real_T LastUAtTimeA_k;               /* '<S8>/Speed' */
  real_T TimeStampB_c;                 /* '<S8>/Speed' */
  real_T LastUAtTimeB_a;               /* '<S8>/Speed' */
  real_T TimeStampA_o;                 /* '<S8>/Acceleration' */
  real_T LastUAtTimeA_d;               /* '<S8>/Acceleration' */
  real_T TimeStampB_f;                 /* '<S8>/Acceleration' */
  real_T LastUAtTimeB_f;               /* '<S8>/Acceleration' */
  real_T DctintegratorR_RWORK[2];      /* '<S3>/DctintegratorR' */
  real_T DctleadlagR_RWORK[2];         /* '<S3>/DctleadlagR' */
  real_T Dct2lowpassR_RWORK[4];        /* '<S3>/Dct2lowpassR' */
  real_T DctintegratorR_RWORK_n[2];    /* '<S4>/DctintegratorR' */
  real_T DctleadlagR_RWORK_o[2];       /* '<S4>/DctleadlagR' */
  real_T Dct2lowpassR_RWORK_o[4];      /* '<S4>/Dct2lowpassR' */
  real_T DctintegratorR_RWORK_a[2];    /* '<S5>/DctintegratorR' */
  real_T DctleadlagR_RWORK_b[2];       /* '<S5>/DctleadlagR' */
  real_T Dct2lowpassR_RWORK_h[4];      /* '<S5>/Dct2lowpassR' */
  struct {
    void *PrevTimePtr;
  } FromFile_PWORK;                    /* '<S1>/From File' */
...
#define rtB                            Performancetot_B
#define BlockIO                        B_Performancetot_T
#define rtP                            Performancetot_P
#define Parameters                     P_Performancetot_T
#define rtDWork                        Performancetot_DW
#define D_Work                         DW_Performancetot_T

/* Parameters (auto storage) */
struct P_Performancetot_T_ {
  ...
  real_T offsetX_Value;                /* Expression: 0
                                        ...
                                        */
  real_T offsetZ_Value;                /* Expression: 0
                                        * Referenced by: '<S1>/offset Z'
                                        */
  real_T GainR_Gain;                   /* Expression: 60
  ...
  real_T Dct2lowpassR_P3;              /* Expression: 0.001
                                        * Referenced by: '<S3>/Dct2lowpassR'
                                        */
  real_T GainR_Gain_p;                 /* Expression: 50
                                        * Referenced by: '<S4>/GainR'
                                        */
  real_T DctintegratorR_P1_Size_f[2];  /* Computed Parameter: DctintegratorR_P1_Size_f
                                        * Referenced by: '<S4>/DctintegratorR'
                                        */
  real_T DctintegratorR_P1_k;          /* Expression: f_num
                                        * Referenced by: '<S4>/DctintegratorR'
                                        */
  real_T DctintegratorR_P2_Size_h[2];  /* Computed Parameter: DctintegratorR_P2_Size_h
                                        * Referenced by: '<S4>/DctintegratorR'
                                        */
  real_T DctintegratorR_P2_n;          /* Expression: 0.001
                                        * Referenced by: '<S4>/DctintegratorR'
                                        */
  real_T DctleadlagR_P1_Size_g[2];     /* Computed Parameter: DctleadlagR_P1_Size_g
                                        * Referenced by: '<S4>/DctleadlagR'
                                        */
  real_T DctleadlagR_P1_l;             /* Expression: f_num
                                        * Referenced by: '<S4>/DctleadlagR'
                                        */
  real_T DctleadlagR_P2_Size_e[2];     /* Computed Parameter: DctleadlagR_P2_Size_e
                                        * Referenced by: '<S4>/DctleadlagR'
                                        */
  real_T DctleadlagR_P2_k;             /* Expression: f_den
                                        * Referenced by: '<S4>/DctleadlagR'
                                        */
  real_T DctleadlagR_P3_Size_l[2];     /* Computed Parameter: DctleadlagR_P3_Size_l
                                        * Referenced by: '<S4>/DctleadlagR'
                                        */
  real_T DctleadlagR_P3_i;             /* Expression: 0.001
                                        * Referenced by: '<S4>/DctleadlagR'
                                        */
  real_T Dct2lowpassR_P1_Size_n[2];    /* Computed Parameter: Dct2lowpassR_P1_Size_n
                                        * Referenced by: '<S4>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P1_i;            /* Expression: f_den
                                        * Referenced by: '<S4>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P2_Size_k[2];    /* Computed Parameter: Dct2lowpassR_P2_Size_k
                                        * Referenced by: '<S4>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P2_l;            /* Expression: b_den
                                        * Referenced by: '<S4>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P3_Size_f[2];    /* Computed Parameter: Dct2lowpassR_P3_Size_f
                                        * Referenced by: '<S4>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P3_h;            /* Expression: 0.001
                                        * Referenced by: '<S4>/Dct2lowpassR'
                                        */
  real_T GainR_Gain_n;                 /* Expression: 110
  ...
  real_T DctintegratorR_P1_a;          /* Expression: f_num
                                        * Referenced by: '<S5>/DctintegratorR'
                                        */
  real_T DctintegratorR_P2_Size_j[2];  /* Computed Parameter: DctintegratorR_P2_Size_j
                                        * Referenced by: '<S5>/DctintegratorR'
                                        */
  real_T DctintegratorR_P2_m;          /* Expression: 0.001
                                        * Referenced by: '<S5>/DctintegratorR'
                                        */
  real_T DctleadlagR_P1_Size_h[2];     /* Computed Parameter: DctleadlagR_P1_Size_h
                                        * Referenced by: '<S5>/DctleadlagR'
                                        */
  real_T DctleadlagR_P1_m;             /* Expression: f_num
                                        * Referenced by: '<S5>/DctleadlagR'
                                        */
  real_T DctleadlagR_P2_Size_a[2];     /* Computed Parameter: DctleadlagR_P2_Size_a
                                        * Referenced by: '<S5>/DctleadlagR'
                                        */
  real_T DctleadlagR_P2_f;             /* Expression: f_den
                                        * Referenced by: '<S5>/DctleadlagR'
                                        */
  real_T DctleadlagR_P3_Size_b[2];     /* Computed Parameter: DctleadlagR_P3_Size_b
                                        * Referenced by: '<S5>/DctleadlagR'
                                        */
  real_T DctleadlagR_P3_o;             /* Expression: 0.001
                                        * Referenced by: '<S5>/DctleadlagR'
                                        */
  real_T Dct2lowpassR_P1_Size_i[2];    /* Computed Parameter: Dct2lowpassR_P1_Size_i
                                        * Referenced by: '<S5>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P1_f;            /* Expression: f_den
                                        * Referenced by: '<S5>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P2_Size_h[2];    /* Computed Parameter: Dct2lowpassR_P2_Size_h
                                        * Referenced by: '<S5>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P2_c;            /* Expression: b_den
                                        * Referenced by: '<S5>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P3_Size_m[2];    /* Computed Parameter: Dct2lowpassR_P3_Size_m
                                        * Referenced by: '<S5>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P3_m;            /* Expression: 0.001
                                        * Referenced by: '<S5>/Dct2lowpassR'
                                        */
  ...
  real_T speed0_Value;                 /* Expression: 0
                                        ...
                                        */
  real_T Gain_Gain_k;                  /* Expression: 0.0015
                                        * Referenced by: '<S7>/Gain'
                                        */
  real_T Gain1_Gain_m;                 /* Expression: 0.001
                                        * Referenced by: '<S7>/Gain1'
                                        */
  real_T fcpos_Value_i;                /* Expression: 0.15
                                        * Referenced by: '<S7>/fc pos'
                                        */
  real_T fcneg_Value_i;                /* Expression: -0.3
                                        * Referenced by: '<S7>/fc neg'
                                        */
  real_T speed0_Value_m;               /* Expression: 0
  ...
  real_T Gain1_Gain_b;                 /* Expression: 0.001
                                        ...
                                        */
  real_T fcpos_Value_f;                /* Expression: 0.2
                                        * Referenced by: '<S8>/fc pos'
                                        */
  real_T fcneg_Value_k;                /* Expression: -0.35
                                        * Referenced by: '<S8>/fc neg'
                                        */
  real_T speed0_Value_mf;              /* Expression: 0
...
struct tag_RTM_Performancetot_T {
  const char_T *path;
...
extern P_Performancetot_T Performancetot_P;

/* Block signals (auto storage) */
extern B_Performancetot_T Performancetot_B;

/* Block states (auto storage) */
extern DW_Performancetot_T Performancetot_DW;

/* External data declarations for dependent source files */
extern const real_T Performancetot_RGND;/* real_T ground */

/* Model entry point functions */
extern void Performancetot_initialize(void);
extern void Performancetot_output(void);
extern void Performancetot_update(void);
extern void Performancetot_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Performancetot_rtModel *Performancetot(void);
...
extern RT_MODEL_Performancetot_T *const Performancetot_M;
 ...
 *
 * '<Root>' : 'Performancetot'
 * '<S1>'   : 'Performancetot/Controller'
 * '<S2>'   : 'Performancetot/Robot Arm'
 * '<S3>'   : 'Performancetot/Controller/Controller R'
 * '<S4>'   : 'Performancetot/Controller/Controller X'
 * '<S5>'   : 'Performancetot/Controller/Controller Z'
 * '<S6>'   : 'Performancetot/Controller/Feedforward R'
 * '<S7>'   : 'Performancetot/Controller/Feedforward X'
 * '<S8>'   : 'Performancetot/Controller/Feedforward Z'
 * '<S9>'   : 'Performancetot/Controller/RTScope'
 * '<S10>'  : 'Performancetot/Robot Arm/__InputSSForSFun__'
 * '<S11>'  : 'Performancetot/Robot Arm/__OutputSSForSFun__'
 */
#endif                                 /* RTW_HEADER_Performancetot_h_ */
