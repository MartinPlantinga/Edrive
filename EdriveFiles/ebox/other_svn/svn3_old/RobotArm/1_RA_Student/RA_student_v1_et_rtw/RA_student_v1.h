...
#ifndef RTW_HEADER_RA_student_v1_h_
#define RTW_HEADER_RA_student_v1_h_
#include <stddef.h>
#include <string.h>
#ifndef RA_student_v1_COMMON_INCLUDES_
# define RA_student_v1_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "dt_info.h"
#include "ext_work.h"
#endif                                 /* RA_student_v1_COMMON_INCLUDES_ */

#include "RA_student_v1_types.h"
...
#define RA_student_v1_rtModel          RT_MODEL_RA_student_v1_T
...
#define rtB                            RA_student_v1_B
#define BlockIO                        B_RA_student_v1_T
#define rtP                            RA_student_v1_P
#define Parameters                     P_RA_student_v1_T
#define rtDWork                        RA_student_v1_DW
#define D_Work                         DW_RA_student_v1_T

/* Parameters (auto storage) */
struct P_RA_student_v1_T_ {
  real_T Solenoid_Y0;                  /* Expression: 0
                                        * Referenced by: '<S1>/Solenoid'
                                        */
  real_T ReferenceR_Value;             /* Expression: 0.2
...
struct tag_RTM_RA_student_v1_T {
  const char_T *path;
...
extern P_RA_student_v1_T RA_student_v1_P;

/* Block signals (auto storage) */
extern B_RA_student_v1_T RA_student_v1_B;

/* Block states (auto storage) */
extern DW_RA_student_v1_T RA_student_v1_DW;

/* External data declarations for dependent source files */
extern const real_T RA_student_v1_RGND;/* real_T ground */

/* Model entry point functions */
extern void RA_student_v1_initialize(void);
extern void RA_student_v1_output(void);
extern void RA_student_v1_update(void);
extern void RA_student_v1_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern RA_student_v1_rtModel *RA_student_v1(void);
...
extern RT_MODEL_RA_student_v1_T *const RA_student_v1_M;
 ...
 *
 * '<Root>' : 'RA_student_v1'
 * '<S1>'   : 'RA_student_v1/Controller'
 * '<S2>'   : 'RA_student_v1/Robot Arm'
 * '<S3>'   : 'RA_student_v1/Controller/Controller R'
 * '<S4>'   : 'RA_student_v1/Controller/Controller X'
 * '<S5>'   : 'RA_student_v1/Controller/Controller Z'
 * '<S6>'   : 'RA_student_v1/Controller/RTScope'
 * '<S7>'   : 'RA_student_v1/Robot Arm/__InputSSForSFun__'
 * '<S8>'   : 'RA_student_v1/Robot Arm/__OutputSSForSFun__'
 */
#endif                                 /* RTW_HEADER_RA_student_v1_h_ */
