...
#
# File    : RAstudent_renamed.mk   $Revision: 1.81.4.22.2.1 $
#
# Abstract:
...
MODEL                = RAstudent_renamed
MODULES              = RAstudent_renamed_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_matrx.c rt_nonfinite.c rt_printf.c rt_sfcn_helper.c 
MAKEFILE             = RAstudent_renamed.mk
MATLAB_ROOT          = /home/ebox/MATLAB/R2015b
ALT_MATLAB_ROOT      = /home/ebox/MATLAB/R2015b
S_FUNCTIONS          = rtiostream_utils.c sf_rt_scope.c Robot_sf.c dlowpass2.c dnotch.c dpd.c dweakint.c ec_Ebox.c ec_EboxResetEnc.c
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 2
TID01EQ              = 1
...
MODELLIB                  = RAstudent_renamedlib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I/home/ebox/svn/RobotArm/RAstudent_renamed_et_rtw \
