...
#ifndef RTW_HEADER_RA1_h_
#define RTW_HEADER_RA1_h_
#include <stddef.h>
#include <string.h>
#include <math.h>
#ifndef RA1_COMMON_INCLUDES_
# define RA1_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#define RA1_rtModel                    RT_MODEL_RA1_T
...
#define rtB                            RA1_B
#define BlockIO                        B_RA1_T
#define rtP                            RA1_P
#define Parameters                     P_RA1_T
#define rtDWork                        RA1_DW
#define D_Work                         DW_RA1_T
...
extern P_RA1_T RA1_P;

/* Block signals (auto storage) */
extern B_RA1_T RA1_B;

/* Block states (auto storage) */
extern DW_RA1_T RA1_DW;

/* External data declarations for dependent source files */
extern const real_T RA1_RGND;          /* real_T ground */

/* Model entry point functions */
extern void RA1_initialize(void);
extern void RA1_output(void);
extern void RA1_update(void);
extern void RA1_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern RA1_rtModel *RA1(void);
...
extern RT_MODEL_RA1_T *const RA1_M;
 ...
 * '<S1>'   : 'RA1/Controller'
 * '<S2>'   : 'RA1/Robot Arm'
 * '<S3>'   : 'RA1/Controller/Controller R'
 * '<S4>'   : 'RA1/Controller/Controller X'
 * '<S5>'   : 'RA1/Controller/Controller Z'
 * '<S6>'   : 'RA1/Controller/RTScope'
 * '<S7>'   : 'RA1/Robot Arm/__InputSSForSFun__'
 * '<S8>'   : 'RA1/Robot Arm/__OutputSSForSFun__'
 */
#endif                                 /* RTW_HEADER_RA1_h_ */
