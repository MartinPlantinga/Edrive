...
#
# File    : Performancetot.mk   $Revision: 1.81.4.22.2.1 $
#
# Abstract:
...
MODEL                = Performancetot
MODULES              = Performancetot_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_matrx.c rt_nonfinite.c rt_printf.c rt_sfcn_helper.c 
MAKEFILE             = Performancetot.mk
MATLAB_ROOT          = /home/ebox/MATLAB/R2015b
ALT_MATLAB_ROOT      = /home/ebox/MATLAB/R2015b
S_FUNCTIONS          = rtiostream_utils.c dleadlag.c sf_rt_scope.c Robot_sf.c dlowpass2.c dnotch.c dpd.c dweakint.c ec_Ebox.c ec_EboxResetEnc.c
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 2
TID01EQ              = 1
...
ADD_INCLUDES = \
	-I/home/lubuntu/Documents/RobotArm_student1/Performancetot_et_rtw \
	-I/home/lubuntu/Documents/RobotArm_student1 \
