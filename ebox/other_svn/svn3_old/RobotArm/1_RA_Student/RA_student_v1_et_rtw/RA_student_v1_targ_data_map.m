  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% RA_student_v1_DW.RobotArm_sfcn_DWORK47
	  section.data(1).logicalSrcIdx = 49;
	  section.data(1).dtTransOffset = 0;
	
	  ;% RA_student_v1_DW.RobotArm_sfcn_DWORK48
	  section.data(2).logicalSrcIdx = 50;
	  section.data(2).dtTransOffset = 1;
	
	  ;% RA_student_v1_DW.RobotArm_sfcn_DWORK49
	  ...
	  ;% RA_student_v1_DW.RobotArm_sfcn_DWORK50
	  section.data(1).logicalSrcIdx = 53;
	  section.data(1).dtTransOffset = 0;
	
	  ;% RA_student_v1_DW.RobotArm_sfcn_DWORK51
	  section.data(2).logicalSrcIdx = 54;
	  section.data(2).dtTransOffset = 1;
	
	  ;% RA_student_v1_DW.RobotArm_sfcn_DWORK52
	  section.data(3).logicalSrcIdx = 55;
	  section.data(3).dtTransOffset = 2;
	
	  ;% RA_student_v1_DW.RobotArm_sfcn_DWORK53
	  section.data(4).logicalSrcIdx = 56;
	  section.data(4).dtTransOffset = 3;
	
	  ;% RA_student_v1_DW.RobotArm_sfcn_DWORK54
	  section.data(5).logicalSrcIdx = 57;
	  section.data(5).dtTransOffset = 4;
	
	  ;% RA_student_v1_DW.RobotArm_sfcn_DWORK55
  ...
  targMap.checksum0 = 95801851;
  targMap.checksum1 = 3364366675;
  targMap.checksum2 = 1407817248;
  targMap.checksum3 = 613891595;
