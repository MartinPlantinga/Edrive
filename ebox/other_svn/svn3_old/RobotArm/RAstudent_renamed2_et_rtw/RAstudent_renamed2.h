...
#ifndef RTW_HEADER_RAstudent_renamed2_h_
#define RTW_HEADER_RAstudent_renamed2_h_
#include <stddef.h>
#include <string.h>
#ifndef RAstudent_renamed2_COMMON_INCLUDES_
# define RAstudent_renamed2_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "dt_info.h"
#include "ext_work.h"
#endif                                 /* RAstudent_renamed2_COMMON_INCLUDES_ */

#include "RAstudent_renamed2_types.h"
...
#define RAstudent_renamed2_rtModel     RT_MODEL_RAstudent_renamed2_T
...
} DW_RAstudent_renamed2_T;

/* Backward compatible GRT Identifiers */
#define rtB                            RAstudent_renamed2_B
#define BlockIO                        B_RAstudent_renamed2_T
#define rtP                            RAstudent_renamed2_P
#define Parameters                     P_RAstudent_renamed2_T
#define rtDWork                        RAstudent_renamed2_DW
#define D_Work                         DW_RAstudent_renamed2_T

/* Parameters (auto storage) */
struct P_RAstudent_renamed2_T_ {
  real_T Solenoid_Y0;                  /* Expression: 0
                                        * Referenced by: '<S1>/Solenoid'
                                        */
  real_T ReferenceR_Value;             /* Expression: 0.1
                                        * Referenced by: '<S1>/Reference R'
                                        */
  real_T Gain_Gain;                    /* Expression: 10
                                        * Referenced by: '<S3>/Gain'
                                        */
  real_T ReferenceX_Value;             /* Expression: 0.4
                                        * Referenced by: '<S1>/Reference X'
                                        */
  real_T Gain_Gain_e;                  /* Expression: 1
                                        * Referenced by: '<S4>/Gain'
                                        */
  real_T ReferenceZ_Value;             /* Expression: 0.4
...
struct tag_RTM_RAstudent_renamed2_T {
  const char_T *path;
...
extern P_RAstudent_renamed2_T RAstudent_renamed2_P;

/* Block signals (auto storage) */
extern B_RAstudent_renamed2_T RAstudent_renamed2_B;

/* Block states (auto storage) */
extern DW_RAstudent_renamed2_T RAstudent_renamed2_DW;

/* External data declarations for dependent source files */
extern const real_T RAstudent_renamed2_RGND;/* real_T ground */

/* Model entry point functions */
extern void RAstudent_renamed2_initialize(void);
extern void RAstudent_renamed2_output(void);
extern void RAstudent_renamed2_update(void);
extern void RAstudent_renamed2_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern RAstudent_renamed2_rtModel *RAstudent_renamed2(void);
...
extern RT_MODEL_RAstudent_renamed2_T *const RAstudent_renamed2_M;
 ...
 *
 * '<Root>' : 'RAstudent_renamed2'
 * '<S1>'   : 'RAstudent_renamed2/Controller'
 * '<S2>'   : 'RAstudent_renamed2/Robot Arm'
 * '<S3>'   : 'RAstudent_renamed2/Controller/Controller R'
 * '<S4>'   : 'RAstudent_renamed2/Controller/Controller X'
 * '<S5>'   : 'RAstudent_renamed2/Controller/Controller Z'
 * '<S6>'   : 'RAstudent_renamed2/Controller/RTScope'
 * '<S7>'   : 'RAstudent_renamed2/Robot Arm/__InputSSForSFun__'
 * '<S8>'   : 'RAstudent_renamed2/Robot Arm/__OutputSSForSFun__'
 */
#endif                                 /* RTW_HEADER_RAstudent_renamed2_h_ */
