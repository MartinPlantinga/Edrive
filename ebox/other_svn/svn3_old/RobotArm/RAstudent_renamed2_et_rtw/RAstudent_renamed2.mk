...
#
# File    : RAstudent_renamed2.mk   $Revision: 1.81.4.22.2.1 $
#
# Abstract:
...
MODEL                = RAstudent_renamed2
MODULES              = RAstudent_renamed2_data.c dleadlag.c dlowpass2.c dnotch.c dpd.c dweakint.c rtGetInf.c rtGetNaN.c rt_logging.c rt_matrx.c rt_nonfinite.c rt_printf.c rt_sfcn_helper.c 
MAKEFILE             = RAstudent_renamed2.mk
MATLAB_ROOT          = /home/ebox/MATLAB/R2015b
ALT_MATLAB_ROOT      = /home/ebox/MATLAB/R2015b
S_FUNCTIONS          = rtiostream_utils.c sf_rt_scope.c Robot_sf.c ec_Ebox.c ec_EboxResetEnc.c
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 2
TID01EQ              = 1
NCSTATES             = 0
COMPUTER             = GLNXA64
BUILDARGS            = OPTS="-DON_TARGET_WAIT_FOR_START=0 -DNETIF_ID=2" MAT_FILE=1 ISPROTECTINGMODEL=NOTPROTECTING
MULTITASKING         = 0
EXT_MODE             = 1
...
MODELLIB                  = RAstudent_renamed2lib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I/home/ebox/svn/RobotArm/RAstudent_renamed2_et_rtw \
	-I/home/ebox/svn/RobotArm \
	-I$(MATLAB_ROOT)/toolbox/shapeit \
...
LDFLAGS = /usr/src/soem/nicdrv.o /usr/src/soem/ethercatbase.o /usr/src/soem/ethercatcoe.o /usr/src/soem/ethercatconfig.o /usr/src/soem/ethercatmain.o -L/usr/lib -lpthread -ltimer_posix -lec -lu1 -lengine
...
%.o : $(MATLAB_ROOT)/toolbox/shapeit/%.c
	@$(GCC_TEST_CMD) $< $(GCC_TEST_OUT)
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $<
...
%.o : /home/ebox/svn/trunk/src/E-box/Apps/E-Scope/engine/%.c
	@$(GCC_TEST_CMD) $< $(GCC_TEST_OUT)
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $<



%.o : $(MATLAB_ROOT)/toolbox/shapeit/%.cpp
	@$(GCC_TEST_CMD) $< $(GCC_TEST_OUT)
	$(CPP) -c $(CPPFLAGS) $<
...
%.o : $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/%.cpp
	@$(GCC_TEST_CMD) $< $(GCC_TEST_OUT)
	$(CPP) -c $(CPPFLAGS) $<
%.o : /home/ebox/svn/trunk/src/E-box/Apps/E-Scope/engine/%.cpp
	@$(GCC_TEST_CMD) $< $(GCC_TEST_OUT)
	$(CPP) -c $(CPPFLAGS) $<
