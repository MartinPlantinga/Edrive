...
#ifndef RTW_HEADER_RAstudent10_h_
#define RTW_HEADER_RAstudent10_h_
#include <stddef.h>
#include <string.h>
#include <math.h>
#ifndef RAstudent10_COMMON_INCLUDES_
# define RAstudent10_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "dt_info.h"
#include "ext_work.h"
#endif                                 /* RAstudent10_COMMON_INCLUDES_ */

#include "RAstudent10_types.h"
...
#define RAstudent10_rtModel            RT_MODEL_RAstudent10_T
...
typedef struct {
  ...
  real_T UniformRandomNumber;          /* '<S1>/Uniform Random Number' */
  real_T Sum4;                         /* '<S1>/Sum4' */
  real_T Sum5;                         /* '<S1>/Sum5' */
  real_T Sum6;                         /* '<S1>/Sum6' */
...
#define rtB                            RAstudent10_B
#define BlockIO                        B_RAstudent10_T
#define rtP                            RAstudent10_P
#define Parameters                     P_RAstudent10_T
#define rtDWork                        RAstudent10_DW
#define D_Work                         DW_RAstudent10_T

/* Parameters (auto storage) */
struct P_RAstudent10_T_ {
  real_T Solenoid_Y0;                  /* Expression: 0
                                        * Referenced by: '<S1>/Solenoid'
                                        */
  real_T ReferenceR_Value;             /* Expression: 2
  ...
  real_T FeedforwardZ_Value;           /* Expression: 0.1
                                        ...
                                        */
  real_T UniformRandomNumber_Minimum;  /* Expression: -0.4
                                        * Referenced by: '<S1>/Uniform Random Number'
                                        */
  real_T UniformRandomNumber_Maximum;  /* Expression: 0.4
                                        * Referenced by: '<S1>/Uniform Random Number'
                                        */
...
extern P_RAstudent10_T RAstudent10_P;

/* Block signals (auto storage) */
extern B_RAstudent10_T RAstudent10_B;

/* Block states (auto storage) */
extern DW_RAstudent10_T RAstudent10_DW;

/* External data declarations for dependent source files */
extern const real_T RAstudent10_RGND;  /* real_T ground */

/* Model entry point functions */
extern void RAstudent10_initialize(void);
extern void RAstudent10_output(void);
extern void RAstudent10_update(void);
extern void RAstudent10_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern RAstudent10_rtModel *RAstudent10(void);
...
extern RT_MODEL_RAstudent10_T *const RAstudent10_M;
 ...
 *
 * '<Root>' : 'RAstudent10'
 * '<S1>'   : 'RAstudent10/Controller'
 * '<S2>'   : 'RAstudent10/Robot Arm'
 * '<S3>'   : 'RAstudent10/Controller/Controller R'
 * '<S4>'   : 'RAstudent10/Controller/Controller X'
 * '<S5>'   : 'RAstudent10/Controller/Controller Z'
 * '<S6>'   : 'RAstudent10/Controller/RTScope'
 * '<S7>'   : 'RAstudent10/Robot Arm/__InputSSForSFun__'
 * '<S8>'   : 'RAstudent10/Robot Arm/__OutputSSForSFun__'
 */
#endif                                 /* RTW_HEADER_RAstudent10_h_ */
