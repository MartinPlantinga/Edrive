...
#ifndef RTW_HEADER_RAtest_h_
#define RTW_HEADER_RAtest_h_
#include <stddef.h>
#include <string.h>
#include <math.h>
#ifndef RAtest_COMMON_INCLUDES_
# define RAtest_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "dt_info.h"
#include "ext_work.h"
#endif                                 /* RAtest_COMMON_INCLUDES_ */

#include "RAtest_types.h"
...
#define RAtest_rtModel                 RT_MODEL_RAtest_T
...
#define rtB                            RAtest_B
#define BlockIO                        B_RAtest_T
#define rtP                            RAtest_P
#define Parameters                     P_RAtest_T
#define rtDWork                        RAtest_DW
#define D_Work                         DW_RAtest_T
...
struct P_RAtest_T_ {
  ...
  real_T FeedforwardZ_Value;           /* Expression: 0.1
                                        ...
                                        */
  real_T UniformRandomNumber_Minimum;  /* Expression: -0.5
...
extern P_RAtest_T RAtest_P;

/* Block signals (auto storage) */
extern B_RAtest_T RAtest_B;

/* Block states (auto storage) */
extern DW_RAtest_T RAtest_DW;

/* External data declarations for dependent source files */
extern const real_T RAtest_RGND;       /* real_T ground */

/* Model entry point functions */
extern void RAtest_initialize(void);
extern void RAtest_output(void);
extern void RAtest_update(void);
extern void RAtest_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern RAtest_rtModel *RAtest(void);
...
extern RT_MODEL_RAtest_T *const RAtest_M;
 ...
 *
 * '<Root>' : 'RAtest'
 * '<S1>'   : 'RAtest/Controller'
 * '<S2>'   : 'RAtest/Robot Arm'
 * '<S3>'   : 'RAtest/Controller/Controller R'
 * '<S4>'   : 'RAtest/Controller/Controller X'
 * '<S5>'   : 'RAtest/Controller/Controller Z'
 * '<S6>'   : 'RAtest/Controller/RTScope'
 * '<S7>'   : 'RAtest/Robot Arm/__InputSSForSFun__'
 * '<S8>'   : 'RAtest/Robot Arm/__OutputSSForSFun__'
 */
#endif                                 /* RTW_HEADER_RAtest_h_ */
