...
#ifndef RTW_HEADER_RA_renamed_h_
#define RTW_HEADER_RA_renamed_h_
#include <stddef.h>
#include <string.h>
#include <math.h>
#ifndef RA_renamed_COMMON_INCLUDES_
# define RA_renamed_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "dt_info.h"
#include "ext_work.h"
#endif                                 /* RA_renamed_COMMON_INCLUDES_ */

#include "RA_renamed_types.h"
...
#define RA_renamed_rtModel             RT_MODEL_RA_renamed_T
...
typedef struct {
  ...
  real_T RobotArm_sfcn_o2[4];          /* '<S2>/Robot Arm_sfcn' */
  real_T Gain1;                        /* '<S4>/Gain1' */
  real_T Dctleadlag2;                  /* '<S4>/Dctleadlag2' */
  real_T Dctintegrator3;               /* '<S4>/Dctintegrator3' */
  real_T Dct2lowpass4;                 /* '<S4>/Dct2lowpass4' */
  real_T Sum4;                         /* '<S1>/Sum4' */
  real_T Gain1_a;                      /* '<S5>/Gain1' */
  real_T Dctleadlag2_g;                /* '<S5>/Dctleadlag2' */
  real_T Dctintegrator3_n;             /* '<S5>/Dctintegrator3' */
  real_T Dct2lowpass4_l;               /* '<S5>/Dct2lowpass4' */
  real_T Sum5;                         /* '<S1>/Sum5' */
  real_T Gain1_ak;                     /* '<S6>/Gain1' */
  real_T Dctleadlag2_p;                /* '<S6>/Dctleadlag2' */
  real_T Dctintegrator3_nr;            /* '<S6>/Dctintegrator3' */
  real_T Dct2lowpass4_h;               /* '<S6>/Dct2lowpass4' */
  real_T Sum6;                         /* '<S1>/Sum6' */
...
typedef struct {
  ...
  real_T Dctleadlag2_RWORK[2];         /* '<S4>/Dctleadlag2' */
  real_T Dctintegrator3_RWORK[2];      /* '<S4>/Dctintegrator3' */
  real_T Dct2lowpass4_RWORK[4];        /* '<S4>/Dct2lowpass4' */
  real_T Dctleadlag2_RWORK_a[2];       /* '<S5>/Dctleadlag2' */
  real_T Dctintegrator3_RWORK_p[2];    /* '<S5>/Dctintegrator3' */
  real_T Dct2lowpass4_RWORK_d[4];      /* '<S5>/Dct2lowpass4' */
  real_T Dctleadlag2_RWORK_a5[2];      /* '<S6>/Dctleadlag2' */
  real_T Dctintegrator3_RWORK_k[2];    /* '<S6>/Dctintegrator3' */
  real_T Dct2lowpass4_RWORK_l[4];      /* '<S6>/Dct2lowpass4' */
...
#define rtB                            RA_renamed_B
#define BlockIO                        B_RA_renamed_T
#define rtP                            RA_renamed_P
#define Parameters                     P_RA_renamed_T
#define rtDWork                        RA_renamed_DW
#define D_Work                         DW_RA_renamed_T

/* Parameters (auto storage) */
struct P_RA_renamed_T_ {
  ...
  real_T SineWave_Phase;               /* Expression: 0
                                        * Referenced by: '<S1>/Sine Wave'
                                        */
  real_T Gain1_Gain;                   /* Expression: 109
  ...
  real_T Dct2lowpass4_P3;              /* Expression: 0.001
                                        * Referenced by: '<S4>/Dct2lowpass4'
                                        */
  real_T ReferenceX_Value;             /* Expression: 0.01
                                        * Referenced by: '<S1>/Reference X'
                                        */
  real_T ReferenceZ_Value;             /* Expression: 0.02
                                        * Referenced by: '<S1>/Reference Z'
                                        */
  real_T Gain1_Gain_c;                 /* Expression: 38
                                        * Referenced by: '<S5>/Gain1'
                                        */
  real_T Dctleadlag2_P1_Size_e[2];     /* Computed Parameter: Dctleadlag2_P1_Size_e
                                        * Referenced by: '<S5>/Dctleadlag2'
                                        */
  real_T Dctleadlag2_P1_n;             /* Expression: f_num
                                        * Referenced by: '<S5>/Dctleadlag2'
                                        */
  real_T Dctleadlag2_P2_Size_f[2];     /* Computed Parameter: Dctleadlag2_P2_Size_f
                                        * Referenced by: '<S5>/Dctleadlag2'
                                        */
  real_T Dctleadlag2_P2_n;             /* Expression: f_den
                                        * Referenced by: '<S5>/Dctleadlag2'
                                        */
  real_T Dctleadlag2_P3_Size_i[2];     /* Computed Parameter: Dctleadlag2_P3_Size_i
                                        * Referenced by: '<S5>/Dctleadlag2'
                                        */
  real_T Dctleadlag2_P3_e;             /* Expression: 0.001
                                        * Referenced by: '<S5>/Dctleadlag2'
                                        */
  real_T Dctintegrator3_P1_Size_o[2];  /* Computed Parameter: Dctintegrator3_P1_Size_o
                                        * Referenced by: '<S5>/Dctintegrator3'
                                        */
  real_T Dctintegrator3_P1_g;          /* Expression: f_num
                                        * Referenced by: '<S5>/Dctintegrator3'
                                        */
  real_T Dctintegrator3_P2_Size_c[2];  /* Computed Parameter: Dctintegrator3_P2_Size_c
                                        * Referenced by: '<S5>/Dctintegrator3'
                                        */
  real_T Dctintegrator3_P2_m;          /* Expression: 0.001
                                        * Referenced by: '<S5>/Dctintegrator3'
                                        */
  real_T Dct2lowpass4_P1_Size_h[2];    /* Computed Parameter: Dct2lowpass4_P1_Size_h
                                        * Referenced by: '<S5>/Dct2lowpass4'
                                        */
  real_T Dct2lowpass4_P1_g;            /* Expression: f_den
                                        * Referenced by: '<S5>/Dct2lowpass4'
                                        */
  real_T Dct2lowpass4_P2_Size_l[2];    /* Computed Parameter: Dct2lowpass4_P2_Size_l
                                        * Referenced by: '<S5>/Dct2lowpass4'
                                        */
  real_T Dct2lowpass4_P2_c;            /* Expression: b_den
                                        * Referenced by: '<S5>/Dct2lowpass4'
                                        */
  real_T Dct2lowpass4_P3_Size_p[2];    /* Computed Parameter: Dct2lowpass4_P3_Size_p
                                        * Referenced by: '<S5>/Dct2lowpass4'
                                        */
  real_T Dct2lowpass4_P3_a;            /* Expression: 0.001
                                        * Referenced by: '<S5>/Dct2lowpass4'
                                        */
  real_T Gain1_Gain_d;                 /* Expression: 45
                                        * Referenced by: '<S6>/Gain1'
                                        */
  real_T Dctleadlag2_P1_Size_o[2];     /* Computed Parameter: Dctleadlag2_P1_Size_o
                                        * Referenced by: '<S6>/Dctleadlag2'
                                        */
  real_T Dctleadlag2_P1_f;             /* Expression: f_num
                                        * Referenced by: '<S6>/Dctleadlag2'
                                        */
  real_T Dctleadlag2_P2_Size_g[2];     /* Computed Parameter: Dctleadlag2_P2_Size_g
                                        * Referenced by: '<S6>/Dctleadlag2'
                                        */
  real_T Dctleadlag2_P2_nq;            /* Expression: f_den
                                        * Referenced by: '<S6>/Dctleadlag2'
                                        */
  real_T Dctleadlag2_P3_Size_h[2];     /* Computed Parameter: Dctleadlag2_P3_Size_h
                                        * Referenced by: '<S6>/Dctleadlag2'
                                        */
  real_T Dctleadlag2_P3_i;             /* Expression: 0.001
                                        * Referenced by: '<S6>/Dctleadlag2'
                                        */
  real_T Dctintegrator3_P1_Size_e[2];  /* Computed Parameter: Dctintegrator3_P1_Size_e
                                        * Referenced by: '<S6>/Dctintegrator3'
                                        */
  real_T Dctintegrator3_P1_o;          /* Expression: f_num
                                        * Referenced by: '<S6>/Dctintegrator3'
                                        */
  real_T Dctintegrator3_P2_Size_o[2];  /* Computed Parameter: Dctintegrator3_P2_Size_o
                                        * Referenced by: '<S6>/Dctintegrator3'
                                        */
  real_T Dctintegrator3_P2_p;          /* Expression: 0.001
                                        * Referenced by: '<S6>/Dctintegrator3'
                                        */
  real_T Dct2lowpass4_P1_Size_n[2];    /* Computed Parameter: Dct2lowpass4_P1_Size_n
                                        * Referenced by: '<S6>/Dct2lowpass4'
                                        */
  real_T Dct2lowpass4_P1_i;            /* Expression: f_den
                                        * Referenced by: '<S6>/Dct2lowpass4'
                                        */
  real_T Dct2lowpass4_P2_Size_e[2];    /* Computed Parameter: Dct2lowpass4_P2_Size_e
                                        * Referenced by: '<S6>/Dct2lowpass4'
                                        */
  real_T Dct2lowpass4_P2_p;            /* Expression: b_den
                                        * Referenced by: '<S6>/Dct2lowpass4'
                                        */
  real_T Dct2lowpass4_P3_Size_f[2];    /* Computed Parameter: Dct2lowpass4_P3_Size_f
                                        * Referenced by: '<S6>/Dct2lowpass4'
                                        */
  real_T Dct2lowpass4_P3_n;            /* Expression: 0.001
                                        * Referenced by: '<S6>/Dct2lowpass4'
                                        */
...
extern P_RA_renamed_T RA_renamed_P;

/* Block signals (auto storage) */
extern B_RA_renamed_T RA_renamed_B;

/* Block states (auto storage) */
extern DW_RA_renamed_T RA_renamed_DW;

/* External data declarations for dependent source files */
extern const real_T RA_renamed_RGND;   /* real_T ground */

/* Model entry point functions */
extern void RA_renamed_initialize(void);
extern void RA_renamed_output(void);
extern void RA_renamed_update(void);
extern void RA_renamed_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern RA_renamed_rtModel *RA_renamed(void);
...
extern RT_MODEL_RA_renamed_T *const RA_renamed_M;
 ...
 *
 * '<Root>' : 'RA_renamed'
 * '<S1>'   : 'RA_renamed/Controller'
 * '<S2>'   : 'RA_renamed/Robot Arm1'
 * '<S3>'   : 'RA_renamed/Controller/RTScope'
 * '<S4>'   : 'RA_renamed/Controller/R_controller'
 * '<S5>'   : 'RA_renamed/Controller/X_controller'
 * '<S6>'   : 'RA_renamed/Controller/Z_controller'
 * '<S7>'   : 'RA_renamed/Robot Arm1/__InputSSForSFun__'
 * '<S8>'   : 'RA_renamed/Robot Arm1/__OutputSSForSFun__'
 */
#endif                                 /* RTW_HEADER_RA_renamed_h_ */
