 ...
 * C source code generated on : Fri Apr  8 09:33:38 2016
 *
...
#ifndef RTW_HEADER_RA_h_
#define RTW_HEADER_RA_h_
#include <stddef.h>
#include <string.h>
#include <math.h>
#ifndef RA_COMMON_INCLUDES_
# define RA_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#define RA_rtModel                     RT_MODEL_RA_T
...
#define rtB                            RA_B
#define BlockIO                        B_RA_T
#define rtP                            RA_P
#define Parameters                     P_RA_T
#define rtDWork                        RA_DW
#define D_Work                         DW_RA_T
...
struct P_RA_T_ {
  ...
  real_T Dct2lowpass4_P3;              /* Expression: 0.001
                                        * Referenced by: '<S4>/Dct2lowpass4'
                                        */
  real_T ReferenceX_Value;             /* Expression: .5
                                        * Referenced by: '<S1>/Reference X'
                                        */
  real_T ReferenceZ_Value;             /* Expression: 1
...
extern DW_RA_T RA_DW;

/* External data declarations for dependent source files */
extern const real_T RA_RGND;           /* real_T ground */

/* Model entry point functions */
extern void RA_initialize(void);
extern void RA_output(void);
extern void RA_update(void);
extern void RA_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern RA_rtModel *RA(void);
...
extern RT_MODEL_RA_T *const RA_M;
 ...
 * '<S1>'   : 'RA/Controller'
 * '<S2>'   : 'RA/Robot Arm1'
 * '<S3>'   : 'RA/Controller/RTScope'
 * '<S4>'   : 'RA/Controller/R_controller'
 * '<S5>'   : 'RA/Controller/X_controller'
 * '<S6>'   : 'RA/Controller/Z_controller'
 * '<S7>'   : 'RA/Robot Arm1/__InputSSForSFun__'
 * '<S8>'   : 'RA/Robot Arm1/__OutputSSForSFun__'
 */
#endif                                 /* RTW_HEADER_RA_h_ */
