...
/*
  ...
  revision history: June, 28th, 2004: start
                    ...
                    April, 20th, 2012: Moved initializing part of rtc_timer to rtc_init_timer
*/
...
int rtc_init_timer(void)
{
    /* Do locking of the address space of a real-time process before 
     * starting the timer to prevent problems with watchdog timers, i.e.
     * watchdog has a timeout because the time between initialize and first 
     * sample is too long */
