...
MAKECMD         = /usr/local/matlab2011b/bin/glnx86/gmake
HOST            = UNIX
BUILD           = yes
...
MODEL              = printer_supervisor01
MODULES            = printer_supervisor01_sf_data.c rtGetInf.c rtGetNaN.c 
MAKEFILE           = printer_supervisor01.mk
MATLAB_ROOT        = /usr/local/matlab2011b
ALT_MATLAB_ROOT    = /usr/local/matlab2011b
MASTER_ANCHOR_DIR  = 
START_DIR          = /home/ebox/svn/trunk/src/E-box/Templates/Specific/printer
S_FUNCTIONS        = ec_Ebox.c dweakint.c dleadlag.c dlowpass2.c dpd.c ec_EboxResetEnc.c
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 2
TID01EQ            = 0
...
COMPUTER           = GLNX86
MEXEXT             = mexglx
BUILDARGS          =  GENERATE_REPORT=0 MODELLIB=printer_supervisor01lib.a RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE
USERMODULES        =  
CREATEMODEL        = 1
USEPARAMVALUES     = 0
PURIFY             = 0
...
ADD_INCLUDES = \
	-I$(START_DIR)/printer_supervisor01_sfcn_rtw \
	-I$(START_DIR) \
