...
case 1
    xgui.chan_enable=1;
    xgui.chan_enable_color=def.COLOR_YELLOW;
end
% offset
...
case 1
    xgui.meas_antialiasing_color=def.COLOR_YELLOW;
...
case 1
    xgui.scope_hold_color=def.COLOR_YELLOW;
end
% freeze
...
case 1
    xgui.scope_freeze_color=def.COLOR_YELLOW;
end
% analog in
...
case 1
    ...
    xgui.trigger_enable_color=def.COLOR_YELLOW;
end
% type
