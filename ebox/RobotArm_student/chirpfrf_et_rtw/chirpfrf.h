 ...
 */
#ifndef RTW_HEADER_chirpfrf_h_
#define RTW_HEADER_chirpfrf_h_
#ifndef chirpfrf_COMMON_INCLUDES_
# define chirpfrf_COMMON_INCLUDES_
#include <stdio.h>
#include <stddef.h>
#include <math.h>
#include <string.h>
...
#endif                                 /* chirpfrf_COMMON_INCLUDES_ */

#include "chirpfrf_types.h"
...
#define chirpfrf_rtModel               RT_MODEL_chirpfrf
...
#define rtB                            chirpfrf_B
#define BlockIO                        BlockIO_chirpfrf
#define rtXdot                         chirpfrf_Xdot
#define StateDerivatives               StateDerivatives_chirpfrf
#define tXdis                          chirpfrf_Xdis
#define StateDisabled                  StateDisabled_chirpfrf
#define rtP                            chirpfrf_P
#define Parameters                     Parameters_chirpfrf
#define rtDWork                        chirpfrf_DWork
#define D_Work                         D_Work_chirpfrf

/* Parameters (auto storage) */
struct Parameters_chirpfrf_ {
...
extern Parameters_chirpfrf chirpfrf_P;

/* Block signals (auto storage) */
extern BlockIO_chirpfrf chirpfrf_B;

/* Block states (auto storage) */
extern D_Work_chirpfrf chirpfrf_DWork;

/* External data declarations for dependent source files */
extern const real_T chirpfrf_RGND;     /* real_T ground */
extern const real_T chirpfrf_RGND;     /* real_T ground */

/* Model entry point functions */
extern void chirpfrf_initialize(boolean_T firstTime);
extern void chirpfrf_output(int_T tid);
extern void chirpfrf_update(int_T tid);
extern void chirpfrf_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_chirpfrf *const chirpfrf_M;
 ...
 *
 * '<Root>' : 'chirpfrf'
 * '<S1>'   : 'chirpfrf/Controller'
 * '<S2>'   : 'chirpfrf/Robot Arm'
 * '<S3>'   : 'chirpfrf/Controller/Chirp Signal'
 * '<S4>'   : 'chirpfrf/Controller/Controller R'
 * '<S5>'   : 'chirpfrf/Controller/Controller X'
 * '<S6>'   : 'chirpfrf/Controller/Controller Z'
 * '<S7>'   : 'chirpfrf/Controller/RTScope'
 * '<S8>'   : 'chirpfrf/Robot Arm/__InputSSForSFun__'
 * '<S9>'   : 'chirpfrf/Robot Arm/__OutputSSForSFun__'
 */
#endif                                 /* RTW_HEADER_chirpfrf_h_ */
