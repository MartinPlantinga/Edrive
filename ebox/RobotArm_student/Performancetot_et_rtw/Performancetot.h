 ...
 * Performancetot.h
 *
 * Code generation for model "Performancetot.mdl".
 *
 * Model version              : 1.969
 * Simulink Coder version : 8.1 (R2011b) 08-Jul-2011
 * C source code generated on : Wed Apr 20 15:30:42 2016
 *
...
#define Performancetot_rtModel         RT_MODEL_Performancetot
...
typedef struct {
  ...
  real_T FromFile1;                    /* '<S1>/From File1' */
  real_T Sum8;                         /* '<S1>/Sum8' */
  real_T FromFile2;                    /* '<S1>/From File2' */
  real_T Sum7;                         /* '<S1>/Sum7' */
  ...
  real_T GainR_n;                      /* '<S4>/GainR' */
  real_T DctintegratorR_j;             /* '<S4>/DctintegratorR' */
  real_T DctleadlagR_n;                /* '<S4>/DctleadlagR' */
  real_T Dct2lowpassR_m;               /* '<S4>/Dct2lowpassR' */
  real_T GainR_k;                      /* '<S5>/GainR' */
  real_T DctintegratorR_b;             /* '<S5>/DctintegratorR' */
  real_T DctleadlagR_i;                /* '<S5>/DctleadlagR' */
  real_T Dct2lowpassR_p;               /* '<S5>/Dct2lowpassR' */
  real_T Speed;                        /* '<S6>/Speed' */
  real_T Speed_b;                      /* '<S7>/Speed' */
  real_T Speed_l;                      /* '<S8>/Speed' */
  real_T Sum4;                         /* '<S1>/Sum4' */
  real_T Sum5;                         /* '<S1>/Sum5' */
  real_T Sum6;                         /* '<S1>/Sum6' */
...
typedef struct {
  ...
  real_T DctintegratorR_RWORK_m[2];    /* '<S4>/DctintegratorR' */
  real_T DctleadlagR_RWORK_e[2];       /* '<S4>/DctleadlagR' */
  real_T Dct2lowpassR_RWORK_l[4];      /* '<S4>/Dct2lowpassR' */
  real_T DctintegratorR_RWORK_h[2];    /* '<S5>/DctintegratorR' */
  real_T DctleadlagR_RWORK_g[2];       /* '<S5>/DctleadlagR' */
  real_T Dct2lowpassR_RWORK_o[4];      /* '<S5>/Dct2lowpassR' */
  struct {
    real_T TimeStampA;
    real_T LastUAtTimeA;
    real_T TimeStampB;
  ...
  struct {
    ...
    real_T TimeStampB;
    real_T LastUAtTimeB;
  } Acceleration_RWORK_l;              /* '<S7>/Acceleration' */
  ...
  struct {
    ...
    real_T TimeStampB;
    real_T LastUAtTimeB;
  } Acceleration_RWORK_i;              /* '<S8>/Acceleration' */
...
} D_Work_Performancetot;

/* Backward compatible GRT Identifiers */
#define rtB                            Performancetot_B
#define BlockIO                        BlockIO_Performancetot
#define rtXdot                         Performancetot_Xdot
#define StateDerivatives               StateDerivatives_Performancetot
#define tXdis                          Performancetot_Xdis
#define StateDisabled                  StateDisabled_Performancetot
#define rtP                            Performancetot_P
#define Parameters                     Parameters_Performancetot
#define rtDWork                        Performancetot_DWork
#define D_Work                         D_Work_Performancetot

/* Parameters (auto storage) */
struct Parameters_Performancetot_ {
  ...
  real_T Dct2lowpassR_P3;              /* Expression: 0.001
                                        * Referenced by: '<S3>/Dct2lowpassR'
                                        */
  real_T GainR_Gain_e;                 /* Expression: 50
                                        * Referenced by: '<S4>/GainR'
                                        */
  real_T DctintegratorR_P1_Size_d[2];  /* Computed Parameter: DctintegratorR_P1_Size_d
                                        * Referenced by: '<S4>/DctintegratorR'
                                        */
  real_T DctintegratorR_P1_m;          /* Expression: f_num
                                        * Referenced by: '<S4>/DctintegratorR'
                                        */
  real_T DctintegratorR_P2_Size_c[2];  /* Computed Parameter: DctintegratorR_P2_Size_c
                                        * Referenced by: '<S4>/DctintegratorR'
                                        */
  real_T DctintegratorR_P2_h;          /* Expression: 0.001
                                        * Referenced by: '<S4>/DctintegratorR'
                                        */
  real_T DctleadlagR_P1_Size_l[2];     /* Computed Parameter: DctleadlagR_P1_Size_l
                                        * Referenced by: '<S4>/DctleadlagR'
                                        */
  real_T DctleadlagR_P1_b;             /* Expression: f_num
                                        * Referenced by: '<S4>/DctleadlagR'
                                        */
  real_T DctleadlagR_P2_Size_g[2];     /* Computed Parameter: DctleadlagR_P2_Size_g
                                        * Referenced by: '<S4>/DctleadlagR'
                                        */
  real_T DctleadlagR_P2_p;             /* Expression: f_den
                                        * Referenced by: '<S4>/DctleadlagR'
                                        */
  real_T DctleadlagR_P3_Size_p[2];     /* Computed Parameter: DctleadlagR_P3_Size_p
                                        * Referenced by: '<S4>/DctleadlagR'
                                        */
  real_T DctleadlagR_P3_g;             /* Expression: 0.001
                                        * Referenced by: '<S4>/DctleadlagR'
                                        */
  real_T Dct2lowpassR_P1_Size_f[2];    /* Computed Parameter: Dct2lowpassR_P1_Size_f
                                        * Referenced by: '<S4>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P1_g;            /* Expression: f_den
                                        * Referenced by: '<S4>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P2_Size_b[2];    /* Computed Parameter: Dct2lowpassR_P2_Size_b
                                        * Referenced by: '<S4>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P2_k;            /* Expression: b_den
                                        * Referenced by: '<S4>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P3_Size_i[2];    /* Computed Parameter: Dct2lowpassR_P3_Size_i
                                        * Referenced by: '<S4>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P3_n;            /* Expression: 0.001
                                        * Referenced by: '<S4>/Dct2lowpassR'
                                        */
  real_T GainR_Gain_a;                 /* Expression: 110
                                        * Referenced by: '<S5>/GainR'
                                        */
  real_T DctintegratorR_P1_Size_h[2];  /* Computed Parameter: DctintegratorR_P1_Size_h
                                        * Referenced by: '<S5>/DctintegratorR'
                                        */
  real_T DctintegratorR_P1_n;          /* Expression: f_num
                                        * Referenced by: '<S5>/DctintegratorR'
                                        */
  real_T DctintegratorR_P2_Size_i[2];  /* Computed Parameter: DctintegratorR_P2_Size_i
                                        * Referenced by: '<S5>/DctintegratorR'
                                        */
  real_T DctintegratorR_P2_m;          /* Expression: 0.001
                                        * Referenced by: '<S5>/DctintegratorR'
                                        */
  real_T DctleadlagR_P1_Size_lr[2];    /* Computed Parameter: DctleadlagR_P1_Size_lr
                                        * Referenced by: '<S5>/DctleadlagR'
                                        */
  real_T DctleadlagR_P1_a;             /* Expression: f_num
                                        * Referenced by: '<S5>/DctleadlagR'
                                        */
  real_T DctleadlagR_P2_Size_f[2];     /* Computed Parameter: DctleadlagR_P2_Size_f
                                        * Referenced by: '<S5>/DctleadlagR'
                                        */
  real_T DctleadlagR_P2_k;             /* Expression: f_den
                                        * Referenced by: '<S5>/DctleadlagR'
                                        */
  real_T DctleadlagR_P3_Size_pf[2];    /* Computed Parameter: DctleadlagR_P3_Size_pf
                                        * Referenced by: '<S5>/DctleadlagR'
                                        */
  real_T DctleadlagR_P3_l;             /* Expression: 0.001
                                        * Referenced by: '<S5>/DctleadlagR'
                                        */
  real_T Dct2lowpassR_P1_Size_o[2];    /* Computed Parameter: Dct2lowpassR_P1_Size_o
                                        * Referenced by: '<S5>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P1_m;            /* Expression: f_den
                                        * Referenced by: '<S5>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P2_Size_e[2];    /* Computed Parameter: Dct2lowpassR_P2_Size_e
                                        * Referenced by: '<S5>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P2_f;            /* Expression: b_den
                                        * Referenced by: '<S5>/Dct2lowpassR'
                                        */
  real_T Dct2lowpassR_P3_Size_h[2];    /* Computed Parameter: Dct2lowpassR_P3_Size_h
                                        * Referenced by: '<S5>/Dct2lowpassR'
                                        */
  ...
  real_T speed0_Value;                 /* Expression: 0
                                        ...
                                        */
  real_T Gain_Gain_h;                  /* Expression: 0.0015
                                        * Referenced by: '<S7>/Gain'
                                        */
  real_T Gain1_Gain_g;                 /* Expression: 0.001
                                        * Referenced by: '<S7>/Gain1'
                                        */
  real_T fcpos_Value_o;                /* Expression: 0.15
                                        * Referenced by: '<S7>/fc pos'
                                        */
  real_T fcneg_Value_p;                /* Expression: -0.3
                                        * Referenced by: '<S7>/fc neg'
                                        */
  real_T speed0_Value_b;               /* Expression: 0
                                        * Referenced by: '<S7>/speed0'
                                        */
  real_T Gain_Gain_p;                  /* Expression: 0.002
                                        * Referenced by: '<S8>/Gain'
                                        */
  real_T Gain1_Gain_j;                 /* Expression: 0.001
                                        * Referenced by: '<S8>/Gain1'
                                        */
  real_T fcpos_Value_c;                /* Expression: 0.2
                                        * Referenced by: '<S8>/fc pos'
                                        */
  real_T fcneg_Value_d;                /* Expression: -0.35
                                        * Referenced by: '<S8>/fc neg'
                                        */
  real_T speed0_Value_be;              /* Expression: 0
...
struct RT_MODEL_Performancetot {
  const char_T *path;
...
extern Parameters_Performancetot Performancetot_P;

/* Block signals (auto storage) */
extern BlockIO_Performancetot Performancetot_B;

/* Block states (auto storage) */
extern D_Work_Performancetot Performancetot_DWork;
...
extern void Performancetot_initialize(boolean_T firstTime);
extern void Performancetot_output(int_T tid);
extern void Performancetot_update(int_T tid);
extern void Performancetot_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_Performancetot *const Performancetot_M;
