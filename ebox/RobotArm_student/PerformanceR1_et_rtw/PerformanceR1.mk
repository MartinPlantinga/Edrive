...
#
# File    : PerformanceR1.mk   $Revision: 1.81.4.22.2.1 $
#
# Abstract:
...
MODEL                = PerformanceR1
MODULES              = PerformanceR1_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_matrx.c rt_nonfinite.c rt_printf.c rt_sfcn_helper.c 
MAKEFILE             = PerformanceR1.mk
MATLAB_ROOT          = /usr/local/matlab2011b
ALT_MATLAB_ROOT      = /usr/local/matlab2011b
S_FUNCTIONS          = ref3.c sf_rt_scope.c Robot_sf.c dlowpass2.c dnotch.c dpd.c dweakint.c ec_Ebox.c ec_EboxResetEnc.c
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 2
TID01EQ              = 1
...
ADD_INCLUDES = \
	-I/home/ebox/Documents/RobotArm_student/PerformanceR1_et_rtw \
