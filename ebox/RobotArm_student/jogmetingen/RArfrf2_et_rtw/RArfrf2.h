 ...
 */
#ifndef RTW_HEADER_RArfrf2_h_
#define RTW_HEADER_RArfrf2_h_
#ifndef RArfrf2_COMMON_INCLUDES_
# define RArfrf2_COMMON_INCLUDES_
#include <stdio.h>
#include <math.h>
#include <stddef.h>
#include <string.h>
...
#endif                                 /* RArfrf2_COMMON_INCLUDES_ */

#include "RArfrf2_types.h"
...
#define RArfrf2_rtModel                RT_MODEL_RArfrf2
...
typedef struct {
  ...
  real_T Sum2;                         /* '<S1>/Sum2' */
  real_T Gain;                         /* '<S3>/Gain' */
  real_T Dctleadlag;                   /* '<S3>/Dctleadlag' */
  real_T Dct1lowpass;                  /* '<S3>/Dct1lowpass' */
  real_T Sum4;                         /* '<S1>/Sum4' */
  real_T Sum5;                         /* '<S1>/Sum5' */
  real_T Sum6;                         /* '<S1>/Sum6' */
  real_T ReferenceSolenoid;            /* '<S1>/Reference Solenoid' */
  real_T SFunction_d[4];               /* '<S6>/S-Function' */
...
typedef struct {
  ...
  real_T Dctleadlag_RWORK[2];          /* '<S3>/Dctleadlag' */
  real_T Dct1lowpass_RWORK[2];         /* '<S3>/Dct1lowpass' */
  struct {
    void *LoggedData;
...
#define rtB                            RArfrf2_B
#define BlockIO                        BlockIO_RArfrf2
#define rtXdot                         RArfrf2_Xdot
#define StateDerivatives               StateDerivatives_RArfrf2
#define tXdis                          RArfrf2_Xdis
#define StateDisabled                  StateDisabled_RArfrf2
#define rtP                            RArfrf2_P
#define Parameters                     Parameters_RArfrf2
#define rtDWork                        RArfrf2_DWork
#define D_Work                         D_Work_RArfrf2

/* Parameters (auto storage) */
struct Parameters_RArfrf2_ {
  ...
  real_T SFunction_P1_Size[2];         /* Computed Parameter: SFunction_P1_Size
                                        ...
                                        */
  real_T SFunction_P1[18];             /* Expression: ref_part
                                        * Referenced by: '<S7>/S-Function'
                                        */
  ...
  real_T ReferenceX_Value;             /* Expression: 0
                                        ...
                                        */
  real_T Gain_Gain_a;                  /* Expression: 0
...
extern Parameters_RArfrf2 RArfrf2_P;

/* Block signals (auto storage) */
extern BlockIO_RArfrf2 RArfrf2_B;

/* Block states (auto storage) */
extern D_Work_RArfrf2 RArfrf2_DWork;

/* External data declarations for dependent source files */
extern const real_T RArfrf2_RGND;      /* real_T ground */
extern const real_T RArfrf2_RGND;      /* real_T ground */

/* Model entry point functions */
extern void RArfrf2_initialize(boolean_T firstTime);
extern void RArfrf2_output(int_T tid);
extern void RArfrf2_update(int_T tid);
extern void RArfrf2_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_RArfrf2 *const RArfrf2_M;
 ...
 *
 * '<Root>' : 'RArfrf2'
 * '<S1>'   : 'RArfrf2/Controller'
 * '<S2>'   : 'RArfrf2/Robot Arm'
 * '<S3>'   : 'RArfrf2/Controller/Controller R'
 * '<S4>'   : 'RArfrf2/Controller/Controller X'
 * '<S5>'   : 'RArfrf2/Controller/Controller Z'
 * '<S6>'   : 'RArfrf2/Controller/RTScope'
 * '<S7>'   : 'RArfrf2/Controller/Subsystem'
 * '<S8>'   : 'RArfrf2/Robot Arm/__InputSSForSFun__'
 * '<S9>'   : 'RArfrf2/Robot Arm/__OutputSSForSFun__'
 */
#endif                                 /* RTW_HEADER_RArfrf2_h_ */
