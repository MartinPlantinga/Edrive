...
#
# File    : testcompz.mk   $Revision: 1.81.4.22.2.1 $
#
# Abstract:
...
MODEL                = testcompz
MODULES              = rtGetInf.c rtGetNaN.c rt_logging.c rt_matrx.c rt_nonfinite.c rt_printf.c rt_sfcn_helper.c testcompz_data.c 
MAKEFILE             = testcompz.mk
MATLAB_ROOT          = /usr/local/matlab2011b
ALT_MATLAB_ROOT      = /usr/local/matlab2011b
S_FUNCTIONS          = sf_rt_scope.c Robot_sf.c dlowpass2.c dnotch.c dpd.c dweakint.c ec_Ebox.c ec_EboxResetEnc.c
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 2
TID01EQ              = 1
...
ADD_INCLUDES = \
	-I/home/ebox/Documents/RobotArm_student/testcompz_et_rtw \
